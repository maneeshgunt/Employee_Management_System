          ...
          <div class="container">
            <div class="row">
              <div class="col s10 m6 l6">
                <h5 class="breadcrumbs-title mt-0 mb-0"><span>Team Information</span></h5>
  ...
  <div class="row">
    <div class="col s12">
      <div class="card">
       ...
       <a href="{{route('Add-Team')}}"><button class="btn waves-effect waves-light cyan btn-sm" type="submit" name="action">Create Team</button></a>
           <br><br>
                ...
                <table id="page-length-option" class="display">
                    ...
                    <thead>
                      <tr>
                        ...
                        <th><b style="font-weight: 700;">Team Leader</b></th>
                    ...
                    @foreach($teams as $data)
                      <tr>
                        ...
                        <td>{{$data->dname}}</td>
                        <td>
                            <a href="{{route('Edit-Team',$data->id)}}"><button class="btn waves-effect waves-light cyan btn-sm" type="button" na><i class='fa fa-edit'></i></button></a>
                            <a href="{{route('DeleteTeam',$data->id)}}"><button class="btn waves-effect waves-light btn-sm" type="submit" ><i class="fa fa-trash-o"></i></button></a>

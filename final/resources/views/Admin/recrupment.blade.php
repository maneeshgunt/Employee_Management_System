          ...
          <div class="container">
            <div class="row">
              <div class="col s10 m6 l6">
                <h5 class="breadcrumbs-title mt-0 mb-0"><span>Recruitment</span></h5>
    ...
    <div class="col s12">
      <div class="card">
        ...
        <div class="card-content">
          ...
          <!-- <a href="weekleytimesheet1.html"><button class="btn waves-effect waves-light cyan btn-sm" type="submit" name="action">Weekley Data</button></a> -->
          ...
          <div class="row">
            <div class="col ">
              <div class="card" style="width: 100%;">
                ...
                <div class="card-body  " style="padding-left:20px ; padding-right:20px;position: center;"><br>
                  

                  <img src="{{ asset('Admin/app-assets/images/gallery/reliablefoot.png')}}">

             
                <p >Reliable Resources is a platform where companies can send their requirments to the admin and then adnin provide them resumes of shortlisted candidates.Candidate can also send there resumes to the admin to get shortlisted.</p><br>
                  &nbsp;&nbsp;<a href="{{url('https://demo.EMS.com/Reliable-Dev/')}}" class="btn waves-effect waves-light cyan btn-sm" type="submit" name="action">Connect To Reliable</a>
                  <br>
                  <br>
                </div>
              </div>

...
<head>
  ...
  <title>EMS</title>
  <link rel="apple-touch-icon" href="./app-assets/images/favicon/EMS.png">
  <link rel="shortcut icon" type="image/x-icon" href="./app-assets/images/favicon/EMS.png">
          ...
          <div class="container">
            <div class="row">
              <div class="col s10 m6 l6">
                <h5 class="breadcrumbs-title mt-0 mb-0"><span>Add Daily TimeSheets</span></h5>
            ...
            <form class="col s12">
              ...
              <div class="row">
                ...
                <div class="input-field col s6">
                  ...
                  <input id="TotalHrs" type="text" class="validate">
              ...
              <div class="row">
                <div class="input-field col s6">
                    ...
                    <button class="btn waves-effect waves-light btn-sm" type="submit" name="action">Submit</button>
                </div>

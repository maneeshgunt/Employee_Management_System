          ...
          <div class="container">
            <div class="row">
              <div class="col s10 m6 l6">
                <h5 class="breadcrumbs-title mt-0 mb-0"><span>Add Performance</span></h5>
        ...
        <div class="card-content">
          ...
          <select name="department">
            ...
            <div class=" col s6">
                ...
                <div class="input-field">
                    <select name="ename" class="select2-size-lg browser-default" id="large-select">
                    @php 
                   $member = DB::table('employees')->select('employees.*')->get();
                  @endphp
                          <option value="" disabled selected>Choose your Member</option>
                          @foreach($member as $mem)
                          <option value="{{ $mem->full_name }}">{{ $mem->full_name }}</option>
                          @endforeach
          ...
          <div class="row">
            ...
            <div class="input-field col s6">
              ...
              <input id="icon_telephone3" type="date" name="date" style="width: 100%;border-left:none;border-right:none;border-top:none">
              
             
            </div>
            <div class="input-field col s6">
                <label >Employee ID</label><br><br>
              <input id="icon_telephone3" type="text" name="empid" style="width: 100%;border-left:none;border-right:none;border-top:none">
              ...
              <div class="row">
                <div class="input-field col s6">
                  ...
                  <a href="{{ route('addperfomance')}}"><button class="btn waves-effect waves-light cyan btn-sm" type="submit" name="action">Add Perfomance</button></a>
                  <!--<button class="btn waves-effect waves-light danger btn-sm" type="submit" name="action">Cancel</button>-->
                   <a href="{{ url('perfomance') }}"  class="btn waves-effect waves-light  btn-sm">Cancel</a>

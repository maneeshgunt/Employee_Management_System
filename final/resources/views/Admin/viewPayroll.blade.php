          ...
          <div class="container">
            <div class="row">
              <div class="col s10 m6 l6">
                <h5 class="breadcrumbs-title mt-0 mb-0"><span>Pay Roll</span></h5>
    ...
    <div class="col s12">
      <div class="card">
        ...
        <div class="card-content">
          ...
          <br><br>
          <div class="row">
            <form action="{{ route('editpayrollslip',$mangepayslips[0]->id)}}" method="post" class="col s12">
              @csrf
<div class="row">
  <div class="input-field col s6">
        <input id="month" type="date" class="validate" name="month" value="{{$mangepayslips[0]->month}}" >
    <label for="month">Month</label>
              ...
              <div class="row">
                <div class="input-field col s6">
                  ...
                  <input id="name" type="text" class="validate" name="ename" value="{{$mangepayslips[0]->full_name}}" readonly>
              ...
              <div class="input-field col s6">
                ...
                <input id="days" type="number" class="validate" name="totalworkingdays" value="{{$mangepayslips[0]->totalworkingdays}}">
...
<div class="row">
                ...
                @endif
                    ...
                    <div class="input-field col s6">
                      ...
                      <input id="paid" type="number" class="validate" name="paiddays" value="{{$mangepayslips[0]->paiddays}}">
              ...
              <div class="row " >
                ...
                <div class="input-field col s6">
                    ...
                    <input id="basic" type="text" class="validate" name="department" value="{{$mangepayslips[0]->department}}">
                ...
                <div class="input-field col s6">
                  ...
                  <input id="special" type="text" class="validate" name="bankname" value="{{$mangepayslips[0]->bankname}}">
              ...
              <div class="row " >
                ...
                <div class="input-field col s6">
                    ...
                    <input id="bonus" type="date" class="validate" name="joindate" value="{{$mangepayslips[0]->joindate}}">
                ...
                <div class="input-field col s6">
                  ...
                  <input id="pf" type="number" class="validate" name="bankaccountnumber" value="{{$mangepayslips[0]->bankaccountnumber}}">
              ...
              <div class="row " >
                ...
                <div class="input-field col s6">
                    ...
                    <input id="conveyance" type="number" class="validate" name="grosssalary" value="{{$mangepayslips[0]->grosssalary}}">
                ...
                <div class="input-field col s6">
                  ...
                  <input id="esi" type="text" class="validate" name="uan" value="{{$mangepayslips[0]->uan}}">
              ...
              <div class="row " >
                ...
                <div class="input-field col s6">
                    ...
                    <input id="leave" type="number" class="validate" name="basicsalary" value="{{$mangepayslips[0]->basicsalary}}">
                ...
                <div class="input-field col s6">
                  ...
                  <input id="medical" type="number" class="validate" name="epf" value="{{$mangepayslips[0]->epf}}">
              ...
              <div class="row " >
                ...
                <div class="input-field col s6">
                    ...
                    <input id="other" type="number" class="validate" name="houserentallowance" value="{{$mangepayslips[0]->houserentallowance}}">
                ...
                <div class="input-field col s6">
                  <input id="total" type="number" class="validate" name="healthinsurance" value="{{$mangepayslips[0]->healthinsurance}}">
              ...
              <div class="row " >
                ...
                <div class="input-field col s6">
                    ...
                    <input id="Conveyance" type="number" class="validate" name="conveyanceallowance" value="{{$mangepayslips[0]->conveyanceallowance}}">
                ...
                <div class="input-field col s6">
                  <input id="tax" type="number" class="validate" name="professionaltax" value="{{$mangepayslips[0]->professionaltax}}">
              ...
              <div class="row " >
                ...
                <div class="input-field col s6">
                    ...
                    <input id="medical" type="number" class="validate" name="medicalallowance" value="{{$mangepayslips[0]->medicalallowance}}">
                ...
                <div class="input-field col s6">
                  <input id="special" type="number" class="validate" name="specialallowance" value="{{$mangepayslips[0]->specialallowance}}">
              ...
              <div class="row " >
                ...
                <div class="input-field col s6">
                  <input id="deduction" type="number" class="validate" name="totaldeduction" value="{{$mangepayslips[0]->totaldeduction}}">
              ...
              <div class="row " >
                ...
                <div class="input-field col s6">
                    ...
                    <input id="net" type="number" class="validate" name="netpay" value="{{$mangepayslips[0]->netpay}}">
                ...
                <div class="input-field col s6">
                  <input id="words" type="text" class="validate" name="amountinwords" value="{{$mangepayslips[0]->amountinwords}}">
             ...
             <a href="{{ url('payroll1') }}"  class="btn waves-effect waves-light  btn-sm">Cancel</a>

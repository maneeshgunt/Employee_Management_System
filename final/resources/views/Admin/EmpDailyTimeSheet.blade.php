        ...
        <nav class="navbar-main navbar-color nav-collapsible sideNav-lock navbar-dark gradient-45deg-indigo-purple no-shadow">
          <div class="nav-wrapper">
            ...
            <ul class="dropdown-content" id="profile-dropdown">
              <li><a class="grey-text text-darken-1" href="profileEmp.html"><i class="material-icons">person_outline</i> Profile</a></li>
    ...
    <div class="col s12">
      <div class="card">
        ...
        <div class="card-content">
          ...
          <a href="addTimesheet.html"><button class="btn waves-effect waves-light btn-sm cyan" type="submit" name="action">Add Timesheet</button></a>
                ...
                <table id="page-length-option" class="display">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>
                            <a href="editTimesheet.html"><button class="btn waves-effect waves-light cyan btn-sm" type="button" name="action"><i></i></button></a>
                      ...
                      <tr>
                        ...
                        <td>
                            <a href="editTimesheet.html"><button class="btn waves-effect waves-light cyan btn-sm" type="button" name="action"><i class='fa fa-edit'></i></button></a>
                            <button class="btn waves-effect waves-light btn-sm" type="submit" name="action"><i class="fa fa-trash-o"></i></button>

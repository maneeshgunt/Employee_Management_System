    ...
    <div class="col s12">
      <div class="card">
        ...
        <div class="card-content">
          ...
          <br><br>
          <div class="row">
            <form action="{{ route('Edit-Team', $members->id) }}" method="post" class="col s12">
            @csrf
              <div class="row">

              <div class="input-field col s6">
               
               <input id="TeamName" type="Text" value="{{ $members->team_name }}" class="validate" name="team_name">
              ...
              <select multiple name="team_member[]">
                  ...
                  @endphp
                          ...
                          <option value="{{ $mem->id }}"{{ $members->team_name == $mem->id ? 'selected':'' }}>{{ $mem->full_name }}</option>
                          @endforeach
                        </select>
...
<div class="input-field col s6">
               ...
               <input id="TeamName1" type="Text"  class="validate" name="team_leader" value="{{ $members->team_leader }}">

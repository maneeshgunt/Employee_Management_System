          ...
          <div class="container">
            <div class="row">
              <div class="col s10 m6 l6">
                <h5 class="breadcrumbs-title mt-0 mb-0"><span>Offer Letter</span></h5>
  ...
  <div class="row">
    <div class="col s12">
      <div class="card">
        ...
        <div class="card-content" id="printMe">
          ...
          <div class="mainDiv" >
            <div class="logo1">
                <img src="{{ asset('Admin/app-assets/images/logo/EMSlogo.png')}}" width="200px">
            </div>
        <div class="header1">
            <h2>Offer letter</h2>
        </div>
        ...
        <div class="headerDate">
            <p id="currentDt">date </p>
            <p >Reference No:<span id="Noref"> {{$employees->id}}</span> </p>


        </div>

        <div class="content">
            <p>Dear  <span>Mr/Miss</span>  <span id="fn">{{$employees->full_name}}</span>,</p>
            <p>Congratulations! </p>

            <span>With reference to your application and subsequent interviews with us. We are pleased to offer you the
                position of</span> <span id="position">{{$employees->designation}}</span> <span>in our organization.</span>
                <br><br>
               <span> You are requested to report to the office on <span id="joiningD">{{$employees->joining_date}}</span> at <span id="JoiningTm">{{$employees->joining_time}}</span> for induction, failing
                which, this offer shall stand withdrawn</span>

            <span>
                Kindly note this is a provisional Offer Letter. By end of your 8 days training, you will be provided with an
    Appointment letter. The offer shall also stand withdrawn if there are discrepancies found in the
    information provided by you.
            </span>
            <br><br>

            <span>We will be verifying the information given by you post your joining.
            </span><br><br>

            <div class="designation">
                <span><b>Designation </span>:<span id="posi"> {{$employees->designation}}</b></span>
                <br><br><br><br>
                <p><b>Salary :<span id="sal">{{$employees->salary}}</span> (per annum)  </b></p>
            </div>
            <br><br>

            <p>should you need any clarification, please get in touch with hr@EMS.com or <span id="hrNO">Contact to {{$employees->hrcontactno}} </span> between
                Monday and Friday during normal working hours.</p>

                <br>
            <p>For,</p>
            <br>

            <p>EMS Solutions Pvt Ltd</p>
                <br>

            <div class="sign">
                <p>Vinayk Jadhav</p>
               <p id="Signature"> Signature of Acceptance</p>
            </div>
            <br><br><br>

            <p>Note: This is an electronic generated file and hence does not require a signature</p>

        </div><br><br><br>


            <div class="address">
                <p id="lastHeading">EMS Solutions Pvt Ltd</p>
               
                <p>EON IT Park, Gera’s Imperium Alpha Building, 8th Floor, Unit No-820, Kharadi-411014</p>
                <div class="lastContact">
                    <p>Email- info@EMS.com</p>
                    <p>Phone- +91 8793932525</p>
                </div>
...
<button onclick="printDiv('printMe')" class="btn waves-effect waves-light cyan  btn-sm">Print Offer Letter</button>
<button  class="btn waves-effect waves-light cyan  btn-sm">Send Offer Letter</button>
<br><br>

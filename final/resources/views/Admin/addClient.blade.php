          ...
          <div class="container">
            <div class="row">
              <div class="col s10 m6 l6">
                <h5 class="breadcrumbs-title mt-0 mb-0"><span>Add Clients</span></h5>
    ...
    <div class="col s12">
            ...
            <form action="" method="post" class="col s12">
              ...
              <div class="row">
                ...
                <div class="input-field col s6">
                  ...
                  <input id="Dev-hrs" type="text" class="validate" name="">
                  <label for="Dev-hrs">Client Name</label>
                  ...
                  <input id="Dev-hrs1" type="number" class="validate" name="">
                  <label for="Dev-hrs1">Mobile No</label>
                ...
                <div class="input-field col s6">
                  ...
                  <input id="Dev-hrs2" type="email" class="validate" name="">
                  <label for="Dev-hrs2">Email</label>
                  ...
                  <input id="Dev-hrs4" type="text" class="validate" name="">
                  <label for="Dev-hrs4">Address</label>
                ...
                <div class="input-field col s6">
                  ...
                  <input id="Dev-hrs10" type="text" class="validate" name="">
                  <label for="Dev-hrs10">Project Name</label>
                ...
                <div class="input-field col s6">
                  ...
                  <input id="Dev-hrs11" type="text" class="validate" name="">
                  <label for="Dev-hrs11">Priority</label>
      ...
      <div class="file-path-wrapper">
        <input class="file-path validate" type="text">
                  ...
                  <input id="Dev-hrs41" type="number" class="validate" name="">
                  <label for="Dev-hrs41">Amount</label>
                 ...
                 <div class="input-field col s6">
                  ...
                  <input id="icon_telephone2" type="date" class="validate" name="start_date">
               
               
               
                  <label for="icon_telephone2">Start Date</label>
                </div>
                <div class="input-field col s6">
               
                  <input id="icon_telephone1" type="date" class="validate" name="start_date">
               
               
               
                  <label for="icon_telephone1">End Date</label>
                </div>
              </div>
              ...
              <div class="row">
                <div class="input-field col s6">
                    <button class="btn waves-effect waves-light btn-sm cyan" type="submit" name="action">Submit</button>
                        ...
                        <a href="{{ url('clientT') }}"  class="btn waves-effect waves-light  btn-sm">Cancel</a>
                </div>

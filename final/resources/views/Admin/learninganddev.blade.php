    ...
    <div class="col s12">
      <div class="card">
        ...
        <div class="card-content">
          ...
          <a href="{{ route('addTraning')}}"><button class="btn waves-effect waves-light cyan btn-sm" type="submit" name="action">Add Training</button></a>
          <a href="{{ route('addmonthlytraining')}}"><button class="btn waves-effect waves-light cyan btn-sm" type="submit" name="action">Add Monthly Test</button></a>
                ...
                <thead>
                  ...
                  <tr>
                   ...
                   <th style="font-weight: 700;">Training Type</th>
                    ...
                    <th style="font-weight: 700;">Cost</th>

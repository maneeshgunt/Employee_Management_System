          ...
          <div class="container">
            <div class="row">z
              <div class="col s10 m6 l6">
                <h5 class="breadcrumbs-title mt-0 mb-0"><span>Create Joining </span></h5>
...
<!--new code End-->
              ...
              <div class="row">
                <div class="input-field col s6">
                    ...
                    <a href="{{ route('Joining_letter')}}"  class="btn waves-effect waves-light  btn-sm cyan">Joining Letter</a>

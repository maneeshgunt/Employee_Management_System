  ...
  <div class="row">
    <div class="col s12">
      <div class="card">
       ...
       <br><br>
          <div class="row">
            <form action="{{route('editLeaveStatus',$manageleaves->id)}}" method="post" class="col s12">
            @csrf
              <div class="row">
              <div class="input-field col s6">
                <select name="leave_status">
                  <option value=" " disabled selected>Choose your option</option>
                  <option value="0" {{ $manageleaves->leave_status == 0 ? 'selected' : 'Pending'}}>Pending</option>
                  <option value="Accept" {{ $manageleaves->leave_status == 1 ? 'selected' : 'Pending'}}>Accept</option>
                  <option value="Decline" {{ $manageleaves->leave_status == 2 ? 'selected' : 'Pending'}}>Decline</option>
                  
                </select>
                <label>Accepet / Decline Leave</label>
            </div>

            <div class="input-field col s6">
               
                <input id="leaveComm" type="Text" class="validate" value="{{ $manageleaves->comments }}" name="comments">
               
                <label for="leaveComm">Comments</label>
              </div>

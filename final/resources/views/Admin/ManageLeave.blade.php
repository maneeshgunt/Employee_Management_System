          ...
          <div class="container">
            <div class="row">
              <div class="col s10 m6 l6">
                <h5 class="breadcrumbs-title mt-0 mb-0"><span>Manage Leave</span></h5>
                ...
                <table id="page-length-option" class="display">
                    <thead>
                      <tr>
                        ...
                        <th><b style="font-weight: 700;">Name</b></th>
                    ...
                    @foreach($manageleaves as $data)
                      <tr>
                        ...
                        <td>{{$data->comments}}</td> 
                        <td>
                            <a class="loginM" href="dowload_requirement/{{ $data->attachment_file }}">
                                                       {{$data->attachment}}
                            </a>
                            </td> 
                        <td>
                            <a href="{{route('editLeave',$data->id)}}"><button class="btn waves-effect waves-light cyan btn-sm" type="submit" name="action">view</button></a>
                            <a href="{{route('deleteLeaves',$data->id)}}"><button class="btn waves-effect waves-light btn-sm" type="submit" name="action"><i class="fa fa-trash-o"></i></button></a>

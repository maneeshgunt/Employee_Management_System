    ...
    <div class="card-content">
      ...
      <div class="row">
        <div class="col s12" id="account">
          ...
          <form id="accountForm" action="{{ route('adminUProfile')}}" method="post">
              @csrf
            <div class="row">
              <div class="col s12 m6">
                <div class="row">
                  ...
                  <div class="col s12 input-field">
                    <input id="name" name="name" type="text" value="{{$admin->name}}" class="validate" 
                      data-error=".errorTxt2">
                    <label for="name">Name</label>
                    <small class="errorTxt2"></small>
                  </div>
                  <div class="col s12 input-field">
                    <input id="email" name="email" type="email" value="{{$admin->email}}" class="validate" 
                      data-error=".errorTxt3">
                    <label for="email">E-mail</label>
                    <small class="errorTxt3"></small>
                  </div>
                  <div class="col s12 input-field">
                    <input id="addr" name="address" type="text" value="{{$admin->address}}" class="validate" 
                      data-error=".errorTxt3">
              ...
              <div class="col s12 m6">
                <div class="row">
                  <div class="col s12 input-field">
                    <input id="phone" name="phone" type="tel" value="{{$admin->phone}}" class="validate" 
                      data-error=".errorTxt2">
                  ...
                  <div class="col s12 input-field">
                    <input  name="password" type="text" value="" class="validate" 
                      data-error=".errorTxt2">
                  ...
                  <div class="col s12 input-field">
                    <input id="city" name="city" type="text" value="{{$admin->city}}" class="validate" 
                      data-error=".errorTxt2">

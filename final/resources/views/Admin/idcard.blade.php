  ...
  <div class="row">
    <div class="col s12">
      <div class="card">
       ...
       <a href="{{ route('CreateID')}}"><button class="btn waves-effect waves-light cyan btn-sm" type="submit" name="action">Create Id</button></a>
           <br><br>
                ...
                <table id="page-length-option" class="display">
                    ...
                    <thead>
                      <tr>
                        ...
                        <th><b style="font-weight: 700;">Profile Image</b></th>
                    ...
                    <tbody>
                        ...
                        <td>img.png</td>
                        <td>
                            <a href="{{route('Editidcard')}}"><button class="btn waves-effect waves-light cyan btn-sm" type="button" na><i class='fa fa-edit'></i></button></a>

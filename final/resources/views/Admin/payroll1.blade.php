          ...
          <div class="container">
            <div class="row">
              <div class="col s10 m6 l6">
                <h5 class="breadcrumbs-title mt-0 mb-0"><span>Manage Salary</span></h5>
    ...
    <div class="col s12">
      <div class="card">
        ...
        <div class="card-content">
          ...
          <a href="{{ route('payroll')}}"><button class="btn waves-effect waves-light cyan btn-sm" type="submit" name="action">Add Salary</button></a>
          <!-- <a href="addEmployee.html"><button class="btn waves-effect waves-light cyan btn-sm" type="submit" name="action">Leave Summary</button></a> -->
              ...
              <table id="page-length-option" class="display">
                <thead>
                  <tr>
                   ...
                   <th style="font-weight: 700;">Full Name</th>
                    <th style="font-weight: 700;">
                      Total Working Days</th>
                    <th style="font-weight: 700;">Designation</th>
                    ...
                    <th style="font-weight: 700;">
                      ...
                      <th style="font-weight: 700;">
                        ...
                        <th style="font-weight: 700;">Date Of Joining</th>
                        <th style="font-weight: 700;">Bank A/C Number</th>
                        <th style="font-weight: 700;">
                          Gross Salary</th>
                        <th style="font-weight: 700;">UAN Number</th>
                        <th style="font-weight: 700;">Basic Salary</th>
                        <th style="font-weight: 700;">EPF</th>
                        <th style="font-weight: 700;"> Conveyance Allowance</th>
                          <th style="font-weight: 700;">Professional Tax</th>
                            <th style="font-weight: 700;">Medical Allowance</th>
                              <th style="font-weight: 700;">Special Allowance</th>
                                <th style="font-weight: 700;">Gross Salary</th>

                                  <th style="font-weight: 700;"> Total Deduction</th>
                                    <th style="font-weight: 700;">Net Pay</th>
                                
                                      <th style="font-weight: 700;">Amount In Words</th>
                                        <th style="font-weight: 700;">Action</th>
                   
                  </tr>
                </thead>
                <tbody>
                    @foreach($mangepayslips as $data)
                  <tr>
                    <td>{{$data->id}}</td>
                    ...
                    <td>
                      <a href="{{ route('viewPayroll',$data->id)}}"><button class="btn waves-effect waves-light cyan btn-sm" type="submit" name="action">Edit</i></button></a>
                     
                      <a href="{{ route('salaryslip',$data->id)}}"><button class="btn waves-effect waves-light cyan btn-sm" type="button" name="action">View Salary slip</i></button></a>
                    </td>

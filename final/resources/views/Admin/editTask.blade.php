        ...
        <div class="container">
          <div class="row">
            <div class="col s10 m6 l6">
              <h5 class="breadcrumbs-title mt-0 mb-0"><span>Edit Task</span></h5>
        ...
        mobile-screen widths are centered automatically.</p>
            ...
            <div class="row">
              <div class="col s12">
                <div class="card">
                  ...
                  <div class="card-content">
                    ...
                    <div class="row">
                      ...
                      <form action="{{ route('update_Task',$proj[0]->id)}}" method="post" class="col s12">
                        @csrf
                       <div class="row">
                      
                    
                          <div class="input-field col s6">
                            <input id="SubDate" type="text" value="{{ $proj[0]->name }}" class="validate"  readonly>
                        ...
                        <div class="row ">
                          <div class="input-field col s6">
                            @php
                   $numhtask=json_decode($proj[0]->module);
                   @endphp
                   @foreach($numhtask as $item )
                 
                            <input id="icon_prefix" type="text" class="validate" name="module[]" value="{{ $item }}">
                          ...
                          <div class="input-field col s6">
                           @php
                   $numh=json_decode($proj[0]->activity);
                   @endphp
                   @foreach($numh as $it)
                            <input id="icon_telephone" type="text" class="validate" name="activity[]" value="{{$it }}">
               ...
               <div class="input-field col s6">
                   @php
                   $numhtaskhours=json_decode($proj[0]->task_hours);
                   @endphp
                   @foreach($numhtaskhours as $item )
                   
                  <input id="Task-hrs" type="text" class="validate" name="task_hours[]" value="{{ $item }}">
                    @endforeach
                  ...
                  <label for="Task-hrs">Task Hours</label>
                        ...
                        <button class="btn waves-effect waves-light btn-sm cyan" type="button" name="action" onclick="addCode()">Add More</button>
                        ...
                        <div class="row">
                          ...
                          <div class="input-field col s6">
                            ...
                            <input id="Dev-hrs" type="text" class="validate" name="developer_hours" value="{{ $proj[0]->developer_hours }}">
                        ...
                        <div class="row">
                          <div class="input-field col s6">
                            <input id="SubDate" type="Date" class="validate" name="submission_date" value="{{ $proj[0]->submission_date }}">
                            <label for="SubDate">Submission Date</label>
                          </div>
                          
                          
                          <div class="input-field col s6">
                    <input id="SubDate" type="text" value="{{ $proj[0]->team_name }}" class="validate" name="team_name"  readonly>

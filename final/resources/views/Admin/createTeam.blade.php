          ...
          <div class="container">
            <div class="row">z
              <div class="col s10 m6 l6">
                <h5 class="breadcrumbs-title mt-0 mb-0"><span>Create Team</span></h5>
    ...
    <div class="col s12">
      <div class="card">
        ...
        <div class="card-content">
          ...
          <br><br>
          <div class="row">
            <form action="{{ route('Add-Team') }}" method="post" class="col s12">
            @csrf
              <div class="row">

              <div class="input-field col s6">
               
               <input id="TeamName" type="Text" class="validate" name="team_name">
              ...
              <select multiple name="team_member[]">
                          @php
                           $mem = DB::table('employees')->select('employees.full_name', 'employees.id')->get();
                          @endphp
...
<!--new code start-->
   <div class="input-field col s6">
               ...
               <input id="TeamName1" type="Text" class="validate" name="team_leader" >
               <label for="TeamName1">Team Leader</label>
        ...
        <select name="designation">
              ...
              <div class="row">
                <div class="input-field col s6">
                    ...
                    <a href="{{ url('create-team') }}"  class="btn waves-effect waves-light  btn-sm">Cancel</a>
                </div>

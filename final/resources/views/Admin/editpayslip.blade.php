          ...
          <div class="container">
            <div class="row">
              <div class="col s10 m6 l6">
                <h5 class="breadcrumbs-title mt-0 mb-0"><span>Edit Payslip</span></h5>
    ...
    <div class="col s12">
      <div class="card">
        ...
        <div class="card-content">
          ...
          <br><br>
          <div class="row">
            <form action="{{ route('editpaySlip',$payslips->id)}}" method="post"  class="col s12" enctype="multipart/form-data">
            ...
            @csrf
              ...
              <div class="row">
                ...
                <div class=" col s6">
                <label>Departments
                  <select name="departmentsp" value="{{$payslips->departmentsp}}">
                  ...
                  <option value="Technical Support" >Technical Support</option>
                    ...
                    <label>Employee</label>
                        <select class="select2 browser-default" value="{{$payslips->employeep}}" name="employeep"  id="ch">
              ...
              <div class="row " >
                        ...
                        <input id="icon_telephone3" type="month" name="monthp" value="{{$payslips->monthp}}" style="width: 100%;border-left:none;border-right:none;border-top:none">
                      ...
                      <div class="input-field col s6">
                        ...
                        <div class="file-field input-field">
                          ...
                          <div class="btn">
                            ...
                            <span>File</span>
                            <input type="file" name="payslipfile" value="{{$payslips->payslipfile}}">
                          </div>

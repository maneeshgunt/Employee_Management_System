          ...
          <div class="container">
            <div class="row">
              <div class="col s10 m6 l6">
                <h5 class="breadcrumbs-title mt-0 mb-0"><span>Add Notification</span></h5>
    ...
    <div class="col s12">
      <div class="card">
        ...
        <div class="card-content">
          ...
          <br><br>
          <div class="row">
            <form action="{{ route('Notificationadd')}}" method="post" class="col s12">
            @csrf
              <div class="row">
              <div class="input-field col s6">
                  ...
                  <select id="tname"  class="validate" name="tname">
               ...
               @endif
                  ...
                  @endphp
                    ...
                    @if($errors->has('emps'))
                 <span class="text-danger">{{ $errors->first('emps') }}</span>
               @endif
              ...
              <div class="row">
                ...
                <div class="input-field col s6">
                  ...
                  <input id="Dev-hrs" type="text" class="validate" name="nTitle">
                  <label for="Dev-hrs">Notification Title</label>
              @if($errors->has('nTitle'))
               ...
               @endif
                  ...
                  <input id="Dev-hrs1" type="text" class="validate" name="nContent">
                  <label for="Dev-hrs1">Notification Content</label>
              @if($errors->has('nContent'))
                 <span class="text-danger">{{ $errors->first('nContent') }}</span>
               @endif
                  <span class="text-danger"></span>
              ...
              <div class="row">
                <div class="input-field col s6">
                    ...
                    <a href="{{ url('Notification') }}"  class="btn waves-effect waves-light  btn-sm">Cancel</a>
                </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            success:function (data) {
                    ...
                    $('#team_member11').html('');
                     $('#team_member11').html('<option value="">Select Members</option>');
                    $.each(data.members,function(index,member){
                            console.log(member)
                            $('#team_member11').append('<option value="'+member.id+'">'+member.full_name+'</option>');
                        })
                    }
                })
            });

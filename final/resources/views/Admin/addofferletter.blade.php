          ...
          <div class="container">
            <div class="row">
              <div class="col s10 m6 l6">
                <h5 class="breadcrumbs-title mt-0 mb-0"><span>Offer Letter Section</span></h5>
    ...
    <div class="col s12">
      <div class="card">
        ...
        <div class="card-content">
          ...
          <br><br>
          <div class="row">
            <form class="col s12" action="{{route('adminofferletter',$employees->id)}}" method="post">
            @csrf
          ...
          <h5>Create Offer Letter</h5>
              ...
              <div class="row">
                <div class="input-field col s6">
                  ...
                  <input id="NameF" type="Text" value="{{$employees->designation}}" class="validate" name="designation" readonly>
                  <label for="NameF">Designation</label>
                </div>
                <div class="input-field col s6">
               
                  <input id="Educ" type="date" class="validate" name="offerdate" >
              ...
              <div class="row">
                <div class="input-field col s6">
                  ...
                  <input id="Addr" type="Text" value="{{$employees->full_name}}" class="validate" name="full_name" readonly>
              ...
              <div class="row">
                <div class="input-field col s6">
                  ...
                  <input id="Email" type="date" value="{{$employees->joining_date}}" class="validate" name="joining_date" readonly>
                  <label for="Email">Joining Date</label>
                </div>
                <div class="input-field col s6">
               
                  <input id="Maritial" type="time" class="validate" name="joining_time">
              ...
              <div class="row">
                <div class="input-field col s6">
                  ...
                  <input id="Mob" type="text" class="validate" name="salary">
                  <label for="Mob">Salary</label>
                </div>
                <div class="input-field col s6">
               
                  <input id="BirthD" type="number"   class="validate" name="hrcontactno">
              ...
              <div class="row">
                <div class="input-field col s6">
                  ...
                  <input id="Blood" type="text" value="{{$employees->id}}" class="validate" name="id" readonly>
              ...
              <div class="">
                <div class="">
                    ...
                    <button class="btn waves-effect waves-light cyan  btn-sm" type="submit" name="action">View Offer letter</button>
                </div>

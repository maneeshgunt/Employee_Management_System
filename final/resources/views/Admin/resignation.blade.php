              ...
              <table id="page-length-option" class="display">
                <thead>
                  <tr>
                   ...
                   <th style="font-weight: 700;">Apply Date</th>
                    <th style="font-weight: 700;">Employee Name</th>
                    <th style="font-weight: 700;">Employee Id</th>
                  
                    <th style="font-weight: 700;">Department</th>
                    <th style="font-weight: 700;">Resign Resion</th>
                    <th style="font-weight: 700;">Notice Period</th>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>{{$data->status}}</td>
                    <td>
                      <a href="aproveresignation/{{$data->id}}"><button class="btn waves-effect waves-light cyan btn-sm" type="button" name="action">View</button></a>

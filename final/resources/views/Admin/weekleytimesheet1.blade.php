          ...
          <div class="container">
            <div class="row">
              <div class="col s10 m6 l6">
                <h5 class="breadcrumbs-title mt-0 mb-0"><span> Manage Attendance</span></h5>
    ...
    <div class="col s12">
      <div class="card">
        ...
        <div class="card-content">
          ...
          <a href="{{ route('weekleytimesheet')}}"><button class="btn waves-effect waves-light cyan btn-sm" type="submit" name="action">Upload Weekly Data</button></a>
          ...
          <div class="row">
            <div class="col s12">
                <table id="page-length-option" class="display">
                    ...
                    <tbody>
                    @foreach($weekleytimesheet as $data)
                      <tr>
                        <td>{{$data->id}}</td>
                        <td>{{$data->month}}</td>
                        ...
                        <td>
                          <a href="download_timesheet/{{ $data->uploadfile }}" class="btn waves-effect waves-light btn-sm cyan" type="submit" name="action"><i class='fa fa-download'></i></button>
                           </td>

          ...
          <div class="container">
            <div class="row">
              <div class="col s10 m6 l6">
                <h5 class="breadcrumbs-title mt-0 mb-0"><span>Termination</span></h5>
    ...
    <div class="col s12">
      <div class="card">
        ...
        <div class="card-content">
          ...
          <div class="row">
            <form action="{{ route('uploadtermination')}}" method="post" class="col s12" enctype="multipart/form-data">
              ...
              <div class="row">
                <div class="input-field col s6">
                  ...
                  <input id="eF" type="Text" class="validate" name="empid">
                  <label for="eF">Employee Id</label>
                </div>
                <div class="input-field col s6">
               
                  <input id="Educ" type="text" class="validate" name="ename">
                  <label for="Educ">Employee Name</label>
                </div>
              </div>
              ...
              <div class="row">
                <div class="input-field col s6">
                  ...
                  <input id="NameF" type="Text" class="validate" name="deapartment">
                  <label for="NameF">Department</label>
                </div>
                <div class="input-field col s6">
               
                  <input id="Educ" type="date" class="validate" name="ldate">
                  <label for="Educ">Last Date</label>
                </div>
              </div>
              ...
              <div class="row">
                ...
                <div class="input-field col s6">
                  ...
                  <input id="F" type="Text" class="validate" name="comment">
                  <label for="F">Comment</label>
                </div>
              </div>
              <div class="row">
                <div class="input-field col s6">
                    <label >Upload Termination Letter</label><br><br>
                  <input id="icon_telephone3" type="file" class="validate" name="tfile">

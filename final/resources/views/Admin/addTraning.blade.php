...
<head>
          ...
          <div class="container">
            <div class="row">
              <div class="col s10 m6 l6">
                <h5 class="breadcrumbs-title mt-0 mb-0"><span>Add Training</span></h5>
  ...
  <div class="row">
    <div class="col s12">
      ...
      <div class="card">
      <form action="{{ route('addTraning1')}}" method="post">
        @csrf
        <div class="card-content">
          ...
          <div class="row">
              ...
              <div class="row">
                <div class="input-field col s6">
                    <label >Traning Type</label><br>
                  <input id="icon_telephone3" type="text" class="validate" name="traningtype" >
                   @if($errors->has('traningtype'))
                  <span class="text-danger">{{ $errors->first('traningtype') }}</span>
                @endif
                ...
                <div class="input-field col s6">
                  ...
                  <input id="icon_telephone4" type="text" class="validate" name="trainername">
                   @if($errors->has('trainername'))
                  <span class="text-danger">{{ $errors->first('trainername') }}</span>
                @endif
              ...
              <div class="row">
                ...
                <div class="input-field col s6">
                    <p>time Duration</p>
              <input id="icon_telephone4" type="text" class="validate" name="timeduration">
               @if($errors->has('timeduration'))
                  <span class="text-danger">{{ $errors->first('timeduration') }}</span>
                @endif
                </div>
              ...
              <div class="row">
                ...
                <div class="input-field col s6">
                  ...
                  <input id="icon_telephone5" type="date" class="validate" name="startDate">
                ...
                <div class="input-field col s6">
                  ...
                  <input id="icon_telephone5" type="date" class="validate" name="endDate">
              ...
              <div class="row">
                ...
                <div class="input-field col s6">
                  ...
                  <input id="icon_telephone6" type="text" class="validate" name="discription">
                ...
                <div class="input-field col s6">
                    ...
                    <label >Cost</label><br>
                  <input id="icon_telephone7" type="text" class="validate" name="cost">
                   @if($errors->has('cost'))
              ...
              <div class="row">
                <div class="input-field col s6">
                 ...
                 <a href="{{ route('learninganddev')}}" class="btn waves-effect waves-light danger btn-sm" type="submit" name="action">Cancel</a>
                </div>

          ...
          <div class="container">
            <div class="row">
              <div class="col s10 m6 l6">
                <h5 class="breadcrumbs-title mt-0 mb-0"><span>Edit Clients</span></h5>
    ...
    <div class="col s12">
           ...
           <form action="" method="post" class="col s12">
              ...
              <div class="row">
                ...
                <div class="input-field col s6">
                  ...
                  <input id="Dev-hrs1" type="text" class="validate" name="">
      ...
      <div class="file-path-wrapper">
        <input class="file-path validate" type="text">
                  ...
                  <input id="Dev-hrs41" type="text" class="validate" name="">

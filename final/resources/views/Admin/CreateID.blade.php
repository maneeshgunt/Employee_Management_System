          ...
          <div class="container">
            <div class="row">z
              <div class="col s10 m6 l6">
                <h5 class="breadcrumbs-title mt-0 mb-0"><span>Create ID </span></h5>
          ...
          <div class="row">
            <form action="" method="post" class="col s12">
              ...
              <div class="input-field col s6">
               ...
               <input id="empname" type="Text" class="validate">
              ...
              <div class="input-field col s6">
               ...
               <label for="desig">Designation</label>
                ...
                <div class="input-field col s6">
                  ...
                  <input id="bgroup" type="Text" class="validate">
              ...
              <div class="row">
                <div class="input-field col s6">
                  ...
                  <label for="prof">Profile Image</label>
                  <br>
                  <br>
                  <input id="prof" type="file" class="validate" name="profile">
                </div>
...
<!--new code End-->
              ...
              <div class="row">
                <div class="input-field col s6">
                    ...
                    <a href="{{ route('idcardPreview')}}"  class="btn waves-effect waves-light  btn-sm cyan">Submit ID</a>

          ...
          <div class="container">
            <div class="row">
              <div class="col s10 m6 l6">
                <h5 class="breadcrumbs-title mt-0 mb-0"><span>Edit Project</span></h5>
    ...
    <div class="col s12">
      <div class="card">
        ...
        <div class="card-content">
          ...
          <br><br>
          <div class="row">
            <form action="{{route('updateproject',$projects->id)}}" method="post" class="col s12" enctype="multipart/form-data">
            @csrf  
            <div class="row">
                <div class="input-field col s6">
        
                  <input id="icon_prefix" type="text" class="validate" name="name" value="{{$projects->name}}" >
                  @if($errors->has('name'))
                ...
                <div class="input-field col s6">
                  ...
                  <input id="icon_telephone" type="date" class="validate" name="start_date" value="{{$projects->start_date}}" >
              ...
              <div class="row">
                <div class="input-field col s6">
                  ...
                  <input id="icon_prefix1" type="date" class="validate" name="end_date" value="{{$projects->end_date}}" >
                ...
                <div class="input-field col s6">
                  ...
                  <input id="hrsT" type="text" class="validate" name="totalhrs" value="{{$projects->totalhrs}}" >
                  @if($errors->has('totalhrs'))
                  <span class="text-danger">{{ $errors->first('totalhrs') }}</span>
                @endif
                  <label for="hrsT">Total Hrs</label>
                </div>
              </div>
              ...
              <div class="row">
                <div class="input-field col s6">
                  ...
                  <input id="icon_prefix2" type="text" class="validate" name="team" value="{{$projects->team}}" >
                  @if($errors->has('team'))
                ...
                <div class="input-field col s3">
                    ...
                    <input id="icon_telephone3" type="hidden" class="validate" name="requirement"  value="{{$projects->requirement}}">
                    <input id="icon_telephone3" type="file" class="validate" name="requirement" style="width:200px;" value="{{$projects->requirement_name}}">
                
                   {{$projects->requirement_name}}
                </div>
              </div>

   ...
   <script>
     function addCode() {
            document.getElementById("add_to_me").innerHTML += 
              "<div class='row ' id='add_to_me'><div class='input-field col s6'> <input id='icon_prefix' type='text' class='validate'><label for='icon_prefix'>Modules</label></div><div class='input-field col s6'><input id='icon_telephone' type='text' class='validate'><label for='icon_telephone'>Activity</label></div></div>";
        }
          ...
          <div class="container">
            <div class="row">
              <div class="col s10 m6 l6">
                <h5 class="breadcrumbs-title mt-0 mb-0"><span>Add Salary</span></h5>
    ...
    <div class="col s12">
      <div class="card">
        ...
        <div class="card-content">
          ...
          <br><br>
          <div class="row">
            <form action="{{ route('addmangepayslip')}}" method="post" class="col s12">
                @csrf
<div class="row">
              ...
              <input id="icon_telephone3" type="month" name="month" style="width: 100%;border-left:none;border-right:none;border-top:none">
               @if($errors->has('month'))
            ...
            <select name="ename">
                  @php 
                   $member = DB::table('employees')->select('employees.*')->get();
                  @endphp
              ...
              <div class="input-field col s6">
                ...
                <input id="days" type="number" class="validate" name="totalworkingdays">
                <label for="days">Total Working Days</label>
             @if($errors->has('totalworkingdays'))
                  <span class="text-danger">{{ $errors->first('totalworkingdays') }}</span>
                @endif
...
<div class="row">
                ...
                @endif
                    ...
                    <div class="input-field col s6">
                      ...
                      <input id="paid" type="number" class="validate" name="paiddays">
                      <label for="paid">Paid Days</label>
                   @if($errors->has('paiddays'))
                  <span class="text-danger">{{ $errors->first('paiddays') }}</span>
                @endif
              ...
              <div class="row " >
                ...
                <div class="input-field col s6">
                    ...
                    <input id="basic" type="text" class="validate" name="department">
                    <label for="basic">Department</label>
                ...
                <div class="input-field col s6">
                  ...
                  <input id="special" type="text" class="validate" name="bankname">
                  <label for="special">Bank Name</label>
              ...
              <div class="row " >
                ...
                <div class="input-field col s6">
                    ...
                    <input id="bonus" type="date" class="validate" name="joindate">
                    <label for="bonus">Date Of Joining</label>
                ...
                <div class="input-field col s6">
                  ...
                  <input id="pf" type="number" class="validate" name="bankaccountnumber">
                  <label for="pf"> Bank A/C Number</label>
                   @if($errors->has('bankaccountnumber'))
                  <span class="text-danger">{{ $errors->first('bankaccountnumber') }}</span>
                @endif
                </div>
              </div>
              ...
              <div class="row " >
                ...
                <div class="input-field col s6">
                    ...
                    <input id="conveyance" type="number" class="validate" name="grosssalary">
                    <label for="conveyance">Gross Salary</label>
                     @if($errors->has('grosssalary'))
                  <span class="text-danger">{{ $errors->first('grosssalary') }}</span>
                @endif
                ...
                <div class="input-field col s6">
                  ...
                  <input id="esi" type="text" class="validate" name="uan">
                  <label for="esi"> UAN</label>
                   @if($errors->has('uan'))
              ...
              <div class="row " >
                ...
                <div class="input-field col s6">
                    ...
                    <input id="leave" type="number" class="validate" name="basicsalary">
                    <label for="leave">Basic Salary</label>
                     @if($errors->has('basicsalary'))
                  <span class="text-danger">{{ $errors->first('basicsalary') }}</span>
                @endif
                ...
                <div class="input-field col s6">
                  ...
                  <input id="medical" type="number" class="validate" name="epf">
                  <label for="medical">EPF</label>
                   @if($errors->has('epf'))
              ...
              <div class="row " >
                ...
                <div class="input-field col s6">
                    ...
                    <input id="other" type="number" class="validate" name="houserentallowance">
                    <label for="other">House Rent Allowance</label>
                     @if($errors->has('houserentallowance'))
                  <span class="text-danger">{{ $errors->first('houserentallowance') }}</span>
                @endif
                ...
                <div class="input-field col s6">
                  <input id="total" type="number" class="validate" name="healthinsurance">
                  <label for="total">Health Insurance/ESI</label>
                   @if($errors->has('healthinsurance'))
                  <span class="text-danger">{{ $errors->first('healthinsurance') }}</span>
                @endif
              ...
              <div class="row " >
                ...
                <div class="input-field col s6">
                    ...
                    <input id="Conveyance" type="number" class="validate" name="conveyanceallowance">
                    <label for="Conveyance">Conveyance Allowance</label>
                     @if($errors->has('conveyanceallowance'))
                  <span class="text-danger">{{ $errors->first('conveyanceallowance') }}</span>
                @endif
                ...
                <div class="input-field col s6">
                  <input id="tax" type="number" class="validate" name="professionaltax">
                  <label for="tax">Professional Tax</label>
                   @if($errors->has('professionaltax'))
                  <span class="text-danger">{{ $errors->first('professionaltax') }}</span>
                @endif
              ...
              <div class="row " >
                ...
                <div class="input-field col s6">
                    ...
                    <input id="medical" type="number" class="validate" name="medicalallowance">
                    <label for="medical">Medical Allowance</label>
                     @if($errors->has('medicalallowance'))
                  <span class="text-danger">{{ $errors->first('medicalallowance') }}</span>
                @endif
                ...
                <div class="input-field col s6">
                  <input id="special" type="number" class="validate" name="specialallowance">
                  <label for="special">Special Allowance</label>
                   @if($errors->has('specialallowance'))
                  <span class="text-danger">{{ $errors->first('specialallowance') }}</span>
                @endif
              ...
              <div class="row " >
                ...
                <div class="input-field col s6">
                  <input id="deduction" type="number" class="validate"name="totaldeduction">
                  <label for="deduction">Total Deduction</label>
                   @if($errors->has('totaldeduction'))
                  <span class="text-danger">{{ $errors->first('totaldeduction') }}</span>
                @endif
              ...
              <div class="row " >
                ...
                <div class="input-field col s6">
                    ...
                    <input id="net" type="number" class="validate" name="netpay">
                    <label for="net">Net Pay</label>
                     @if($errors->has('netpay'))
                  <span class="text-danger">{{ $errors->first('netpay') }}</span>
                @endif
                ...
                <div class="input-field col s6">
                  <input id="words" type="text" class="validate" name="amountinwords">
                  <label for="words">Amount In Words</label>
                   @if($errors->has('amountinwords'))
                  <span class="text-danger">{{ $errors->first('amountinwords') }}</span>
                @endif
              ...
              <a href="{{ route('payroll1')}}" class="btn waves-effect waves-light danger btn-sm" type="submit" name="action">Cancel</a>

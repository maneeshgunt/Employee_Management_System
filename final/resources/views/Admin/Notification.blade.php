    ...
    <div class="col s12">
      <div class="card">
        ...
        <div class="card-content">
         ...
         <a href="{{route('addnotification')}}"><button class="btn waves-effect waves-light cyan btn-sm" type="submit" name="action">Add Notification</button></a>
         <br>
                ...
                <table id="page-length-option" class="display">
                    <thead>
                      <tr>
                       ...
                       <th style="font-weight: 700;">Team Name</th>
                        <th style="font-weight: 700;">Employee Names</th>
                      
                        <th style="font-weight: 700;">Notification Title</th>
                        <th style="font-weight: 700;">Notification Content</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>@foreach($data->full_name as $d)
                            {{$loop->iteration}}. {{$d}}<br>
                            @endforeach</td>
                                    <td>{{$data->nTitle}}</td>
                                    <td>{{$data->nContent}}</td>
                                     <td>
                            <a href="{{route('editnotification',$data->id)}}" class="btn waves-effect waves-light cyan btn-sm" type="button" name="action"><i class='fa fa-edit'></i></a>
                            <a href="{{route('deleteNotification',$data->id)}}"class="btn waves-effect waves-light btn-sm" type="submit" name="action"><i class="fa fa-trash-o"></i></a>

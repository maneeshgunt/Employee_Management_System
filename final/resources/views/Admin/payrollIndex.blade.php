...
<div  style="display: flex; justify-content:space-around;">
        <!--<a href="{{ route('manageSalaryM')}}"><div class="card padding-3 animate fadeLeft " style="width:250px ;">-->
        <!--    <div  class="row">-->
        <!--     <div class="col s5 m5">-->
            <!--      <h5 class="mb-0">View Payslip</h5>-->
        ...
        <!--   </div>-->
        <!-- </div></a>-->
         <a href="{{ route('payroll1')}}"> <div class="card padding-3 animate fadeLeft " style="width:250px ;">
            <div class="row">
                <div class="col s5 m5">
                   <h5 class="mb-0">Manage Salary</h5>

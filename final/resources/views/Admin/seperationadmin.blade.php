          ...
          <div class="container">
            <div class="row">
              <div class="col s10 m6 l6">
                <h5 class="breadcrumbs-title mt-0 mb-0"><span>Seperation</span></h5>
...
<div  style="display: flex; justify-content:space-around;">
        <a href="{{ route('resignation')}}"><div class="card padding-3 animate fadeLeft " style="width:250px ;">
            <div  class="row">
               <div class="col s5 m5">
                  <h5 class="mb-0">Resignation Request</h5>
         ...
         <!--<a href="{{ route('seperation')}}"> <div class="card padding-3 animate fadeLeft " style="width:250px ;">-->
         <!--   <div class="row">-->
         <!--       <div class="col s5 m5">-->

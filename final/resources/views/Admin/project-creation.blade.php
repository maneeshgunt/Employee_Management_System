    ...
    <div class="col s12">
      <div class="card">
        ...
        <div class="card-content">
          ...
          <a href="{{route('addproject')}}"><button class="btn waves-effect waves-light cyan btn-sm" type="submit" name="action">Add Project</button></a>
                ...
                <table id="page-length-option" class="display">
                    ...
                    <thead>
                      <tr>
                        ...
                        <th><b style="font-weight: 700;">Start Date</b></th>
                        <th><b style="font-weight: 700;">End Date</b></th>
                        <th><b style="font-weight: 700;">Total hrs</b></th>
                        <th><b style="font-weight: 700;">Team</b></th>
                        <th><b style="font-weight: 700;">Requirement</b></th>
                    ...
                    @foreach($projects as $data)
                      <tr>
                        <td>{{ $i++ }}</td>
                        <td>
                            <a  class="name" href="{{ route('taskCreation', $data->id) }}">{{$data->name}}</a>
                        </td>
                        ...
                        <td>
                            <a href="{{route('editProject',$data->id)}}"><button class="btn waves-effect waves-light cyan btn-sm" type="button" name="action"><i class='fa fa-edit'></i></button></a>
                            <a href="{{route('deleteproject',$data->id)}}"><button class="btn waves-effect waves-light btn-sm" type="submit" name="action"><i class="fa fa-trash-o"></i></button></a>
                            @endforeach
                        </td>
                      </tr>
                    </tbody>

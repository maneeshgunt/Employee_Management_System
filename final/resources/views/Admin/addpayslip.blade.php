          ...
          <div class="container">
            <div class="row">
              <div class="col s10 m6 l6">
                <h5 class="breadcrumbs-title mt-0 mb-0"><span>Add Payslip</span></h5>
    ...
    <div class="col s12">
      <div class="card">
        ...
        <div class="card-content">
          ...
          <br><br>
          <div class="row">
            <form  action="{{ route('payslip')}}" method="post" class="col s12" enctype="multipart/form-data">
            @csrf
              ...
              <div class="row">
                ...
                <div class=" col s6">
                  ...
                  <option value="Technical Support" >Technical Support</option>
                     ...
                     @if($errors->has('departmentsp'))
                  <span class="text-danger">{{ $errors->first('departmentsp') }}</span>
                @endif
                    </div>
                    <div class=" col s6">
                        <label>Employee</label>
                        <select class="select2 browser-default"  name="employeep"  id="ch">
                ...
                @php 
                  ...
                  @endphp
                          ...
                          @endforeach
                           ...
                           @if($errors->has('employeep'))
                  <span class="text-danger">{{ $errors->first('employeep') }}</span>
                @endif
                          </div>
              </div>
              ...
              <div class="row " >
                        ...
                        <input id="icon_telephone3" type="month" name="monthp" style="width: 100%;border-left:none;border-right:none;border-top:none">
                        
                        @if($errors->has('monthp'))
                  <span class="text-danger">{{ $errors->first('monthp') }}</span>
                @endif
                      </div>
                      ...
                      <div class="input-field col s6">
                        ...
                        <div class="file-field input-field">
                          ...
                          <div class="btn">
                            ...
                            <span>File</span>
                            <input type="file" name="payslipfile">
                             
                          </div>
                          @if($errors->has('payslipfile'))
                  <span class="text-danger">{{ $errors->first('payslipfile') }}</span>
                @endif
              ...
              <a href="{{ url('manageSalaryM') }}"  class="btn waves-effect waves-light  btn-sm">Cancel</a>

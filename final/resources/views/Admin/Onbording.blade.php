          ...
          <div class="container">
            <div class="row">
              <div class="col s10 m6 l6">
                <h5 class="breadcrumbs-title mt-0 mb-0"><span>Onboarding</span></h5>
...
<div  style="display: flex; justify-content:space-around;">
              ...
              <a href="{{ route('Offer')}}">
            <div class="card padding-3 animate fadeLeft " style="width:220px ;">
            <div  class="row">
               <div class="col s5 m5">
               ...
               <div class="col s7 m7 right-align">
                 ...
                 <a href="{{ route('Joining')}}" >
            <div class="card padding-3 animate fadeLeft " style="width:220px ;">
            <div  class="row">
               <div class="col s5 m5">
                  <h5 class="mb-0">Joining Letter</h5>

          ...
          <div class="container">
            <div class="row">
              <div class="col s10 m6 l6">
                <h2 class="breadcrumbs-title ">Joining Letter</h2>
  ...
  <!--<div class="row ">-->
    ...
    <div class=" card d-flex ">
      <div class=" color_blue">
          <div class="card-content ">
             <img class="float-right" style="position:relative;" width="250px"height="110px"  src="{{ asset('Admin/app-assets/images/logo/EMSlogo.png')}}" /></td>
       </div>
        ...
        <div class="arrow-left">
         <!--for red color-->
          ...
          <div class=" color_blue1 mt-1">
          <!--aa-->
         </div>
         
          <div class="color_blue2 mt-1">
          <!--<p>duiguasicauo</p>-->
         </div>

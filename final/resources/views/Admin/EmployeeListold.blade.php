              ...
              <table id="page-length-option" class="display">
                <thead>
                  <tr>
                   ...
                   <th><b style="font-weight: 700;">Full Name</b></th>
                    <th><b style="font-weight: 700;">Education</b></th>
                    <th><b style="font-weight: 700;">Address</b></th>
                  
                    <th><b style="font-weight: 700;">Designation</b></th>
                    <th><b style="font-weight: 700;">Email</b></th>
                    <th><b style="font-weight: 700;">Maritial Status</b></th>
                    <th><b style="font-weight: 700;">Mobile No</b></th>
                    <th><b style="font-weight: 700;">Birth Date</b></th>
                    <th><b style="font-weight: 700;">Blood Group</b></th>
                    <th><b style="font-weight: 700;">Joining Date</b></th>
                    <th><b style="font-weight: 700;">Employee ID</b></th>
                    <th><b style="font-weight: 700;">Relieving Date</b></th>
                    <th><b style="font-weight: 700;">Emergency Contact No.</b></th>
                    <th><b style="font-weight: 700;">Gender</b></th>
                    <th><b style="font-weight: 700;">Aadhar Card</b></th>
                    <th><b style="font-weight: 700;">Pan Card</b></th>
                    <th><b style="font-weight: 700;">Bank Passbook/cheque</b></th>
                    <th><b style="font-weight: 700;">Mark List</b></th>
                ...
                @foreach($employees as $data)
                  <tr>
                    ...
                    <td>
                      <a href="{{route('editEmployee',$data->id)}}"><button class="btn waves-effect waves-light cyan btn-sm" type="button" name="action"><i class='fa fa-edit'></i></button></a>
                      <a href="{{route('deleteEmployeeList',$data->id)}}"><button class="btn waves-effect waves-light btn-sm" type="submit" name="action" onclick="return confirm('Are you sure?')"><i class="fa fa-trash-o"></i></button></a>

          ...
          <div class="container">
            <div class="row">
              <div class="col s10 m6 l6">
                <h5 class="breadcrumbs-title mt-0 mb-0"><span>Approve Resignation</span></h5>
    ...
    <div class="col s12">
      <div class="card">
        ...
        <div class="card-content">
          ...
          <br><br>
          <div class="row">
            <form  action="{{ route('approveReg',$resignations->id)}}" method="POST" class="col s12">
            @csrf

              <div class="row">
                <div class="input-field col s6">
        
                  <input id="icon_prefix" type="text" class="validate" value="{{$resignations->fullname}}" readonly>
                ...
                <div class="input-field col s6">
                  ...
                  <input id="icon_prefix" type="number" class="validate" value="{{$resignations->employeeid}}" readonly>
              ...
              <div class="row">
                <div class="input-field col s6">
                    ...
                    <input id="icon_prefix1" type="text" class="validate" value="{{$resignations->department}}" readonly>
              ...
              <div class="row">
                ...
                <div class="input-field col s6">
                  ...
                  <input id="icon_prefix1" type="date" class="validate" value="{{$resignations->startdate}}" readonly>
                  <label for="icon_prefix1">Start Date</label>
                </div>

                <div class="input-field col s6">
        
                  <input id="icon_prefix1" type="date" class="validate" value="{{$resignations->enddate}}" readonly>
             ...
             <div class="row">
                <div class="input-field col s6">
                    ...
                    <input id="icon_prefix1" type="text" class="validate" value="{{$resignations->resignationreaason}}" readonly>
                    <label for="icon_prefix1">Resignation Reason</label>
                  </div>
...
<br>
              ...
              <div class="row">
                <div class="input-field col s6">
                    ...
                    <select name="status">
                        <option value="" disabled selected>Resignation Status</option>
                ...
                <div class="input-field col s6">
                    ...
                    <input id="c1" type="text" class="validate" name="comments">
                    <label for="c1">Comment</label>

...
<head>
   <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@3.3.7/dist/css/bootstrap.min.css" integrity="sha384-BVYiiSIFeK1dGmJRAkycuHAHRg32OmUcww7on3RYdg4Va+PmSTsz/K68vbdEjh4u" crossorigin="anonymous">
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('Admin/app-assets/css/pages/login.css')}}">
  ...
  <div class="col s12 m6 l4 z-depth-4 card-panel border-radius-6 login-card bg-opacity-8">
    <form  action="{{route('verify')}}" method="post" class="login-form">
        @csrf
      <div class="row">
        <div class="input-field col s12">
             <!--<center><img src="{{ asset('Admin/app-assets/images/logo/EMSlogo.png')}}" alt="avatar" style="width="26" height="60""/></center>-->
             <center><h3>EMS</h3></center>
        <center><h5><b>Admin Login</b></h5></center>
      ...
      <div class="row margin">
        <div class="input-field col s12">
          <i  class="material-icons prefix pt-2 icon_colo" >person_outline</i>
      ...
      <div class="row margin">
        <div class="input-field col s12">
         <i class="material-icons prefix pt-2 icon_colo">lock_outline</i>
...
<!-- Mirrored from pixinvent.com/materialize-material-design-admin-template/html/ltr/vertical-modern-menu-template/user-login.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 16 Nov 2021 11:09:50 GMT -->
</html>
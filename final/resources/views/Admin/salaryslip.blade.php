    ...
    <div class="col s12">
      <div class="card">
        ...
        <div class="card-content">
          ...
          <img style="position:relative;" width="150px"height="50px"  src="{{ asset('Admin/app-assets/images/logo/EMSlogo.png')}}" /></td>
          ...
          <div class="salary1" >
            ...
            <!-- <tr>
                ...
                <td colspan='4' class="companyName" style="color:white ;">EMS Solutions</td> 
              </tr>  -->
              <tr>
                <th>
                 Employee Name

...
<html class="loading" lang="en" data-textdirection="ltr">
  <head>
    ...
    <link
      ...
      href="./app-assets/images/favicon/EMS.png"
    />
    <link
      rel="shortcut icon"
      type="image/x-icon"
    ...
    <link
      rel="stylesheet"
      type="text/css"
      href="./app-assets/vendors/data-tables/css/select.dataTables.min.css"
    />
    <!-- END: VENDOR CSS-->
    ...
    <link
      rel="stylesheet"
      type="text/css"
      href="./app-assets/css/pages/data-tables.min.css"
    />
    <!-- END: Page Level CSS-->
    <!-- BEGIN: Custom CSS-->
    <link
  ...
  >
        ...
        >
          <div class="nav-wrapper">
            ...
            <ul class="dropdown-content" id="profile-dropdown">
              <li>
                <a class="grey-text text-darken-1" href="profileEmp.html"
                      ...
                      <div class="row">
                        <form class="col s12">
                          ...
                          <div class="row">
                            <div class="input-field col s6">
                              <button
                                class="btn waves-effect waves-light cyan btn-sm"
                                type="submit"
                                name="action"
                              >
                                Submit
    ...
    >
      <div class="footer-copyright">
        <div class="container">
          <span
            >&copy; 2022 <a href="#" target="_blank">EMS</a> All rights
            reserved.</span
          >
        </div>
      </div>

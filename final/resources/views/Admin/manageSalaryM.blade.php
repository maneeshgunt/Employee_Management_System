          ...
          <div class="container">
            <div class="row">
              <div class="col s10 m6 l6">
                <h5 class="breadcrumbs-title mt-0 mb-0"><span>Payslip</span></h5>
    ...
    <div class="col s12">
      <div class="card">
        ...
        <div class="card-content">
          ...
          <a href="{{ route('addpayslip')}}"><button class="btn waves-effect waves-light cyan btn-sm" type="submit" name="action">Add Payslip</button></a>
              ...
              <table id="page-length-option" class="display">
                <thead>
                  <tr>
                   ...
                   <th style="font-weight: 700;">Employee</th>
                    ...
                    <th style="font-weight: 700;">View Payslip</th>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>{{$data->departmentsp}}</td>
                    
                   
                    <td>{{$data->monthp}}</td>

                    <td> <a href="download_payslip/{{ $data->payslipfile }}"class="btn waves-effect waves-light btn-sm cyan" type="submit" name="action"><i class="fa fa-download"></i></a></td>
                
                    <td>
                      <a href="editPpayslip/{{$data->id}}"><button class="btn waves-effect waves-light cyan btn-sm" type="submit" name="action"><i class='fa fa-edit'></i></button></a>
                      <a href="{{route('deletepayslip',$data->id)}}"><button class="btn waves-effect waves-light btn-sm" type="submit" name="action"><i class="fa fa-trash-o"></i></button></a>

        ...
        <div class="container">
          <div class="row">
            <div class="col s10 m6 l6">
              <h5 class="breadcrumbs-title mt-0 mb-0"><span>Task Creation</span></h5>
              ...
              <div class="col s12">
                <div class="card">
                  ...
                  <div class="card-content">
                    ...
                    <a href="{{route('addTask', request('id'))}}"><button class="btn waves-effect waves-light cyan btn-sm" type="submit" name="action">Add Task</button></a>
                        ...
                        <table id="page-length-option" class="display">
                          <thead>
                            <tr>
                              ...
                              <!--<th>Project Name</th>-->
                              <th><b style="font-weight: 700;">Project Name</b></th>
                              <th><b style="font-weight: 700;">Module</b></th>
                              <th><b style="font-weight: 700;">Activity</b></th>
                              <th><b style="font-weight: 700;">Task Hours</b></th>
                              <th><b style="font-weight: 700;">Developer Hours</b></th>
                              <th><b style="font-weight: 700;">Submission Date</b></th>
                              <th><b style="font-weight: 700;">Team Name</b></th>
                              <th><b style="font-weight: 700;">Team Member</b></th>
                              <th><b style="font-weight: 700;">Developer Status</b></th>
                          ...
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td>
                                @php
                                $modules = $data->module ? json_decode($data->module, true) : []; @endphp
                              ...
                              <td>
                                @php
                                $activitys = $data->activity ? json_decode($data->activity, true) : []; @endphp
                                @foreach($activitys as $activity)
                                {{$activity}}<br>
                                @endforeach
                              </td>
                            <td>@php
                                $activitys = $data->task_hours ? json_decode($data->task_hours, true) : []; @endphp
                                @foreach($activitys as $activity)
                                {{$activity}}<br>
                                @endforeach</td>
                           
                              <td>{{$data->developer_hours}}</td>
                              ...
                              <td>
                                <a href="{{route('editTask',$data->id)}}"><button class="btn waves-effect waves-light cyan btn-sm" type="submit" name="action"><i class='fa fa-edit'></i></button></a>
                                <a href="{{route('deletetask', $data->id)}}" class="btn waves-effect waves-light btn-sm" type="submit" name="action" onclick="return confirm('Are you sure?')"><i class="fa fa-trash-o"></i></a>
                                @endforeach
                                @endif
                                </td>
                            </tr>

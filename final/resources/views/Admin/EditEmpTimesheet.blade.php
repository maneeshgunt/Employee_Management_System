          ...
          <div class="container">
            <div class="row">
              <div class="col s10 m6 l6">
                <h5 class="breadcrumbs-title mt-0 mb-0"><span>Edit Daily TimeSheets</span></h5>
    ...
    <div class="col s12">
      <div class="card">
        ...
        <div class="card-content">
          ...
          <br><br>
          <div class="row">
            <form action="{{route('update',$timesheets->id)}}" method="post" class="col s12">
              @csrf
              <div class="row">
                <div class="input-field col s6">
        
                  <input id="icon_prefix" type="date" class="validate" name="date" value="{{$timesheets->date}}" >
                  @if($errors->has('date'))
                ...
                <div class="input-field col s6">
                  ...
                  <input id="Proj_Name" type="text" class="validate" name="proj_name" value="{{$timesheets->proj_name}}" >
              ...
              <div class="row">
                  ...
                  <input id="icon_telephone" type="text" class="validate"  name="developer_name" value="{{$timesheets->developer_name}}" >
                  @if($errors->has('developer_name'))
                  <span class="text-danger">{{ $errors->first('developer_name') }}</span>
                @endif
                  <label for="icon_telephone">Developer Name</label>
                </div>
                ...
                <div class="input-field col s6">
                  ...
                  <input id="icon_prefix1" type="text" class="validate"  name="productivity_hours" value="{{$timesheets->productivity_hours}}" >
              ...
              <div class="row">
                <div class="input-field col s6">
                  ...
                  <input id="TotalHrs" type="text" class="validate"  name="review_hours" value="{{$timesheets->review_hours}}">
                ...
                @endif
                 ...
                 <div class="input-field col s6">
                    <input id="icon_prefix2" type="text" class="validate"  name="others" value="{{$timesheets->others}}">

...
<style>
     ...
     .color_blue2
    {
        width: 100%;
        height: 50px;
         /*border-left: 1035px solid #00bfff;*/
  ...
  border-right:350px solid #a52a2a; 
}
     ...
     <script>
        function printDiv() {
            var divContents = document.getElementById("idcard1").innerHTML;
            var a = window.open('', '', );
  ...
  <body class="vertical-layout vertical-menu-collapsible page-header-dark vertical-modern-menu preload-transitions 2-columns   " data-open="click" data-menu="vertical-modern-menu" data-col="2-columns">
    ...
    <div id="main">
      <div class="row">
          ...
          <div class="container">
            <div class="row">
              <div class="col s10 m6 l6">
                <h5 class="breadcrumbs-title mt-0 mb-0"><span>ID Card</span></h5>
        ...
        <div class="col s12">
          <div class="container" >
            <div class="section section-data-tables " id="printMe">
  <!-- <div class="card">
  ...
  <!--<div class="row ">-->
    ...
    <div id="idcard1" style="display:flex;justify-content:space-evenly;">
    <div class="card"  style="height:600px;width:380px;background-image:url({{ asset('Admin/app-assets/images/logo/id1.png')}});background-repeat:no-repeat;background-size: cover;">
      <div class="card-body">
          <img style="position:relative;left:80px;top:30px;" width="230px"height="100px"  src="{{ asset('Admin/app-assets/images/logo/EMSlogo.png')}}" /></td>
          <img style="position:relative;left:105px;top:30px;border-radius:50%;" width="170px"height="160px"  src="{{ asset('Admin/app-assets/images/avatar/profile11.jpg')}}" /></td> 
         <br>
         <br>
          <h5 style="text-align:center;"><b>Supriya Bhosale</b></h5>
          <h6 style="text-align:center;"><b>ADMIN</b></h6>
          <br>
          <br>
          <div style="text-align:center;color:black;">
            <span><b>EMP ID -</b></span><span><b> V233452</b></span>
            <br>
            <span><b>Blood Group -</b></span><span><b> B +ve</b></span>
          </div>
          <br>
          
          <hr class="text-red" style="width:50%;border: 1px solid #EC1C3C">
          <p style="position:relative;text-align:center;color:black;bottom:15px;"><b>www.EMS.com</b></p>
          </div>
          </div>
          
          
          <div class="card" style="height:600px;width:380px;background-image:url({{ asset('Admin/app-assets/images/logo/Group1.png')}});background-repeat:no-repeat;background-size: cover;">
              <div class="card-body">
            <img style="position:relative;left:80px;top:30px;" width="230px"height="100px"  src="{{ asset('Admin/app-assets/images/logo/EMSlogo.png')}}" /></td>          
                <br><br><br><br><br><br><br>
                <div style="text-align:center;color:black;line-height: 0.5;">
                <p>if found please return to</p>
                <p><b>EMS Solutions Pvt.Ltd.</b></p>
                <p>Unit no.820, Gera's Imperium Alpha,</p>
                <p>Vitthal Nagar, Kharadi,</p>
                <p>Pune, Maharashtra 411014</p>
              </div>
              <br>
              <div style="text-align:center;color:black;">
            <span><b>Phone :</b></span><span><b> +91 20 7117 7070</b></span>
            <br>
            <span><b>Email Id :</b></span><span><b> info@EMS.com</b></span>
          </div>
          <br><br>
          <hr class="text-red" style="width:50%;border: 1px solid #EC1C3C">
          <p style="position:relative;text-align:center;color:black;bottom:15px;"><b>www.EMS.com</b></p>
     ...
     <center><button class="btn waves-effect waves-light btn modal-trigger cyan" onclick="printDiv()">Print</button></center>
...
<!--<button class="btn waves-effect waves-light cyan btn-sm" onclick="printDiv('printMe')">Print Salary Slip</button>-->
<!--<button class="btn waves-effect waves-light cyan btn-sm" >Send Salary Slip</button>-->
<!--<a href="{{ route('payroll1')}}" class="btn waves-effect waves-light  btn-sm" >Cancel</a>-->
<br>
<br>

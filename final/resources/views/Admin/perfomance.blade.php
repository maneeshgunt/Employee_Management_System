          ...
          <div class="container">
            <div class="row">
              <div class="col s10 m6 l6">
                <h5 class="breadcrumbs-title mt-0 mb-0"><span>Perfomance</span></h5>
    ...
    <div class="col s12">
      <div class="card">
        ...
        <div class="card-content">
          ...
          <a href="{{route('addTotalPerfomance')}}"><button class="btn waves-effect waves-light cyan btn-sm" type="submit" name="action">Add Perfomance</button></a>
              ...
              <table id="page-length-option" class="display">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                      <a href="{{ route('admineditperfomance')}}"><button class="btn waves-effect waves-light cyan btn-sm" type="button" name="action"><i class='fa fa-edit'></i></button></a>

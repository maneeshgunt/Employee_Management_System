    ...
    <div class="col s12">
      <div class="card">
        ...
        <div class="card-content">
          ...
          {{$monthlytrainings->id}}
          {{$monthlytrainings->departments}}
          {{$monthlytrainings->employee}}
          {{$monthlytrainings->month}}
          <iframe width="400" height="400" src='/Admin/app-assets/images/monthlytraining/{{$monthlytrainings->trainingfile}}' ></iframe>

    ...
    <div class="col s12">
      <div class="card">
        ...
        <div class="card-content">
         ...
         <a href="{{route('addClient')}}"><button class="btn waves-effect waves-light cyan btn-sm" type="submit" name="action">Add Client</button></a>
                ...
                <table id="page-length-option" class="display">
                    <thead>
                      <tr>
                        ...
                        <th style="font-weight: 700;">Client Name</th>
                        ...
                        <th style="font-weight: 700;">Project Name</th>
                          <th style="font-weight: 700;">Project Requirement</th>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>3434</td>
                                     ...
                                     <td>
                            <a href="{{route('editClient')}}"><button class="btn waves-effect waves-light cyan btn-sm" type="button" name="action"><i class='fa fa-edit'></i></button></a>
                            <a href=""><button class="btn waves-effect waves-light btn-sm" type="submit" name="action"><i class="fa fa-trash-o"></i></button></a>

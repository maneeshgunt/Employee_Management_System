    ...
    <div class="col s12">
      <div class="card">
        ...
        <div class="card-content">
          ...
          <br><br>
          <div class="row">
            <form action="{{ route('update_Status',$tasks->id)}}" method="post" class="col s12">
              ...
              <div class="row">
                ...
                <div class="input-field col s6">
                  ...
                  <input id="Assign" type="date" class="validate" value="{{$tasks->assign_date}}" readonly>
                  <label for="Assign">Assign Date</label>
                </div>

                <div class="input-field col s6">
        
                    <input id="Submission" type="date" class="validate" value="{{$tasks->assign_date}}" readonly>
              ...
              <div class="row">
                ...
                <div class="input-field col s6">
                  ...
                  <input id="Module" type="text" class="validate" value="{{$tasks->assign_date}}" readonly>
                  <label for="Module">Module</label>
                </div>

                <div class="input-field col s6">
        
                    <input id="Activity" type="text" class="validate" value="{{$tasks->assign_date}}" readonly>
              ...
              <div class="row">
                ...
                <div class="input-field col s6">
                  ...
                  <input id="Total" type="text" class="validate" value="{{$tasks->assign_date}}" readonly>
                  <label for="Total">Total Hrs</label>
                </div>

                <div class="input-field col s6">
        
                    <input id="Developer" type="text" class="validate" value="{{$tasks->developer_status}}" name="developer_status">
                    <label for="Developer">Developer Status</label>
                  </div>
              </div>
              ...
              <div class="row">
                ...
                <div class="input-field col s6">
                  ...
                  <input id="QA" type="text" class="validate" name="qa_status" value="{{$tasks->qa_status}}" >
                  <label for="QA">QA Status</label>
                </div>

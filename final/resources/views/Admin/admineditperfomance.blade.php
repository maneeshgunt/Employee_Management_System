...
<!-- Mirrored from pixinvent.com/materialize-material-design-admin-template/html/ltr/vertical-modern-menu-template/table-data-table.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 16 Nov 2021 11:10:43 GMT -->
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="{{ asset('Admin/app-assets/images/favicon/favicon-32x32.png')}}">
  ...
  <div class="row">
    <div class="col s12">
      <div class="card">
        <div class="card-content">
          <h4 class="card-title"> <b> Professional Excellence</b> 
          </h4>
        ...
        <!--new code start  -->
         ...
         <b>Personal Excellence</b> 
          ...
          <!--new code start-->
          <div class="card-content">
          <h4 class="card-title"> <b>Special Initiatives, Achievements, contributions if any</b>   
          </h4>
          <div class="row" style="overflow-y: hidden;overflow-x: auto">
            <div class="col s12">
              <div class="container">
        ...
        <!--new code start-->
          <div class="card-content">
          <h4 class="card-title"> <b>Comments on the role</b>      
          </h4>
          <div class="row" style="overflow-y: hidden;overflow-x: auto">
            <div class="col s12">
              <div class="container">
    ...
    <br>
        <!--new code start-->
        <div class="card-content">
          <h4 class="card-title"> <b>Any other general comments, observations, suggestions etc.</b>    
          </h4>
          <div class="row" style="overflow-y: hidden;overflow-x: auto">
            <div class="col s12">
              <div class="container">
          ...
          <div style="display: flex; justify-content:center">
            <button class="btn waves-effect waves-light cyan btn-sm" type="button" name="action">Submit</button>

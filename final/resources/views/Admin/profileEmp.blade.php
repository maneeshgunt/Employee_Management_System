          ...
          <div class="container">
            <div class="row">
              <div class="col s10 m6 l6">
                <h5 class="breadcrumbs-title mt-0 mb-0"><span>Users Profile</span></h5>
            ...
            <div class="row">
              <div class="col s12 m6">
                <div class="row">
                  ...
                  <div class="col s12 input-field">
                    <input id="addr" name="email" type="email" class="validate" 
                      data-error=".errorTxt3">
              ...
              <div class="col s12 m6">
                <div class="row">
                  ...
                  <div class="col s12 input-field">
                    <input id="pass" name="name" type="password" class="validate" 
                      data-error=".errorTxt2">
                  ...
                  <div class="col s12 input-field">
                    <input id="city" name="name" type="text" class="validate" 
                      data-error=".errorTxt2">

                ...
                <table id="page-length-option" class="display">
                    <thead>
                      <tr>
                        ...
                        <th><b style="font-weight: 700;">Date</b></th>
                        <th><b style="font-weight: 700;">Project Name</b></th>
                        <th><b style="font-weight: 700;">Developer Name</b></th>
                        <th><b style="font-weight: 700;">Productivity Hours</b></th>
                        <th><b style="font-weight: 700;">Review Hours</b></th>
                        <th><b style="font-weight: 700;">Others</b></th>
                    ...
                    @foreach($timesheets as $data)
                      <tr>
                        ...
                        <td>{{$data->productivity_hours}}</td>
                        <td>{{$data->review_hours}}</td>
                        <td>{{$data->others}}</td>
                        
                        <td>
                            <!---<a href="{{route('editemptimesheet',$data->id)}}"><button class="btn waves-effect waves-light btn-sm cyan" type="button" name="action"><i class='fa fa-edit'></i></button></a>--->
                            <a href="{{route('deletetimesheet',$data->id)}}"><button class="btn waves-effect waves-light btn-sm" type="submit" name="action" onclick="return confirm('Are you sure?')"><i class="fa fa-trash-o"></i></button></a>
                        </td>

          ...
          <div class="container">
            <div class="row">
              <div class="col s10 m6 l6">
                <h5 class="breadcrumbs-title mt-0 mb-0"><span>Weekly Timesheet</span></h5>
    ...
    <div class="col s12">
      <div class="card">
        ...
        <div class="card-content">
          ...
          <br><br>
          <div class="row">
            <form action="{{ route('uploadweekelytimesheet')}}" method="post"  enctype="multipart/form-data" class="col s12">
              @csrf
              <div class="row">
              ...
              <div class="row">
                ...
                <div class="input-field col s6">
                  ...
                  <input id="icon_telephone" type="date" class="validate" name="startdate" >
              ...
              <div class="row">
                <div class="input-field col s6">
                 ...
                 <a href="{{ url('weekleytimesheet1') }}"  class="btn waves-effect waves-light  btn-sm">Cancel</a>
                </div>

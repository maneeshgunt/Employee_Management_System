          ...
          <div class="container">
            <div class="row">
              <div class="col s10 m6 l6">
                <h5 class="breadcrumbs-title mt-0 mb-0"><span>Edit Notification</span></h5>
    ...
    <div class="col s12">
      <div class="card">
        ...
        <div class="card-content">
          ...
          <br><br>
          <div class="row">
            <form action="{{route('editNot',$notification[0]->id)}}" method="post" class="col s12">
           ...
           @csrf
              ...
              <div class="input-field col s6">
                  ...
                  <input id="Dev-hrs" type="text" class="validate" name="tname" value="{{$notification[0]->team_name}}" readonly>
              ...
              <div class="row">
                ...
                <div class="input-field col s6">
                  ...
                  <input id="Dev-hrs" type="text" class="validate" value="{{$notification[0]->nTitle}}" name="nTitle">
                  ...
                  <input id="Dev-hrs1" type="text" class="validate" value="{{$notification[0]->nContent}}" name="nContent">

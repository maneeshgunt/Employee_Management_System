          ...
          <div class="container">
            <div class="row">
              <div class="col s10 m6 l6">
                <h5 class="breadcrumbs-title mt-0 mb-0"><span>Employee Timesheet</span></h5>
    ...
    <div class="col s12">
      <div class="card">
        ...
        <div class="card-content">
          ...
          <a href="{{route('addTimesheet')}}"><button class="btn waves-effect waves-light btn-sm cyan" type="submit" name="action">Add Timesheet</button></a>
                 ...
                 <table id="page-length-option" class="display">
                    <thead>
                      <tr>
                        ...
                        <th style="font-weight: 700;">Department Name</th>
                        <th style="font-weight: 700;">Employee Name</th>
                        
                        <th style="font-weight: 700;">Project Name</th>
                        <th style="font-weight: 700;">1st Hr</th>
                        <th style="font-weight: 700;">2nd Hr</th>
                        <th style="font-weight: 700;">3rd Hr</th>
                        <th style="font-weight: 700;">4th Hr</th>
                        <th style="font-weight: 700;">5th Hr</th>
                        <th style="font-weight: 700;">6th Hr</th>
                        <th style="font-weight: 700;">7th Hr</th>
                        <th style="font-weight: 700;">8th Hr</th>
                        <th style="font-weight: 700;">9th Hr</th>
                        <th style="font-weight: 700;">10th Hr</th>
                        <th style="font-weight: 700;">11th Hr</th>
                        <th style="font-weight: 700;">12th Hr</th>
                      
                        <th style="font-weight: 700;">In Time</th>
                        <th style="font-weight: 700;">Out Time</th>
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                            ...
                            <a href="{{route('deletetimesheetEmp',$data->id)}}" class="btn waves-effect waves-light btn-sm" type="submit" name="action"><i class="fa fa-trash-o"></i></button>
                            </td>
                            </tr>

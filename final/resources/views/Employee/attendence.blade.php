          ...
          <div class="container">
            <div class="row">
              <div class="col s10 m6 l6">
                <h5 class="breadcrumbs-title mt-0 mb-0"><span>Attendance </span></h5>
          ...
          <div class="row">
            <div class="col s12">
                <table id="page-length-option" class="display">
                    ...
                    <tbody>
                    @foreach($weekleytimesheets as $data)
                      <tr>
                        <td>{{$data->id}}</td>
                        <td>{{$data->month}}</td>
                        ...
                        <td>
                            <a href="download_timesheetE/{{ $data->uploadfile }}">  <button class="btn waves-effect waves-light btn-sm cyan" type="submit" name="action"><i class='fa fa-download'></i></a></button>

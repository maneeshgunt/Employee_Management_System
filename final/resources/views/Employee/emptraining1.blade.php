          ...
          <div class="container">
            <div class="row">
              <div class="col s10 m6 l6">
                <h5 class="breadcrumbs-title mt-0 mb-0"><span>Training Status</span></h5>
    ...
    <div class="col s12">
      <div class="card">
        ...
        <div class="card-content">
          ...
          <br><br>
          <form action="{{ route('updatetraining',$trainings->id)}}" method="post">
             ...
             <br>
              ...
              <div class="row">
                <div class="input-field col s6">
                  ...
                  <a class="btn waves-effect waves-light   btn-sm " type="submit" name="action" href="{{ route('empTraning')}}">Cancel</a>

...
<head>
  ...
  <div class="col s12 m6 l4 z-depth-4 card-panel border-radius-6 login-card bg-opacity-8">
    <form class="login-form" action="{{route('verifyE')}}" method="post">
      @csrf
      <div class="row">
        ...
        <center><h5><b>Employee Login</b></h5></center>
      ...
      <div class="row margin">
        <div class="input-field col s12 ">
          ...
          <input id="emp_id" type="text" name="email">
          <label for="emp_id"  class="center-align bold_cols">Email</label>
          @if($errors->has('email'))

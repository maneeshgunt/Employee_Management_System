          ...
          <div class="container">
            <div class="row">
              <div class="col s10 m6 l6">
                <h5 class="breadcrumbs-title mt-0 mb-0"><span>Resignation</span></h5>
    ...
    <div class="col s12">
      <div class="card">
        ...
        <div class="card-content">
          ...
          <a href="{{ route('applyresignation')}}"><button class="btn waves-effect waves-light cyan btn-sm" type="submit" name="action">Apply</button></a>
                ...
                <table id="page-length-option" class="display">
                    <thead>
                      ...
                      <tr>
                        ...
                        <th style="font-weight: 700;">Resignation Reason</th>

          ...
          <div class="container">
            <div class="row">
              <div class="col s10 m6 l6">
                <h5 class="breadcrumbs-title mt-0 mb-0"><span>Apply Resignation</span></h5>
    ...
    <div class="col s12">
      <div class="card">
        ...
        <div class="card-content">
          ...
          <br><br>
          <div class="row">
            <form action="{{route('applyResign')}}" method="post" class="col s12">
            @csrf

              <div class="row">
                <div class="input-field col s6">
        
                  <input id="icon_prefix" type="text" class="validate" name="fullname" value="{{$employees->full_name}}" readonly>
                ...
                <div class="input-field col s6">
                  ...
                  <input id="icon_pre" type="number" class="validate" name="employeeid" value="{{$employees->employee_id}}" readonly>
                  <label for="icon_pre">Employee Id</label>
              ...
              <div class="row">
                <div class="input-field col s6">
                    ...
                    <input id="icon_prefix1" type="text" class="validate" name="department">
                    <label for="icon_prefix1">Department</label>
             ...
             <div class="row">
                <div class="input-field col s6">
                    ...
                    <input id="icon_prefi" type="text" class="validate" name="resignationreaason">
                    <label for="icon_prefi">Resignation Reason</label>
                    @if($errors->has('resignationreaason'))
                  <span class="text-danger">{{ $errors->first('resignationreaason') }}</span>
                @endif
                  </div>
        ...
        <input id="icon_prefix1" type="date" class="validate" name="date">
        <label for="icon_prefix1">Date</label>
        @if($errors->has('date'))
      ...
      <div class="row">
                <div class="input-field col s6">
                    ...
                    <input id="icon_prefix1" type="date" class="validate" name="startdate">
                    <label for="icon_prefix1">Start Date</label>
        ...
        <input id="icon_prefix1" type="date" class="validate" name="enddate">
        ...
        @if($errors->has('enddate'))
              ...
              <div class="row">
                <div class="input-field col s6">
                   ...
                   <input id="icon_pre" type="number" class="validate" name="eid" value="{{$employees->id}}" readonly>
                  <label for="icon_pre">Employee Id</label>
              ...
              <div class="row">
                <div class="input-field col s6">
                    ...
                    <a href="{{ route('resignationemployee')}}" class="btn waves-effect waves-light danger btn-sm">Cancel</a>
                  </div>

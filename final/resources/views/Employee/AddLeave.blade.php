          ...
          <div class="container">
            <div class="row">
              <div class="col s10 m6 l6">
                <h5 class="breadcrumbs-title mt-0 mb-0"><span>Apply Leave</span></h5>
    ...
    <div class="col s12">
      <div class="card">
        ...
        <div class="card-content">
          ...
          <br><br>
          <div class="row">
            <form action="{{route('aAddLeave')}}" method="post" class="col s12" enctype="multipart/form-data">
              @csrf
              <div class="row">
                ...
                <div class="input-field col s6">
                    ...
                    <input id="icon_prefix" type="date" class="validate" name="end_date">
              ...
              <div class="row">
                ...
                <div class="input-field col s6">
                   ...
                   <input id="icon_prefix1" type="text" class="validate"  name="leave_reason">
                    <label for="icon_prefix1">Leave Reason</label>
                ...
                @endif
                 ...
                 <div class="input-field col s6">
                    <input id="TotalHrs" type="text" class="validate"  name="leave_days">
                  <label for="TotalHrs">Leave Days</label>
                ...
                @endif
                    <input id="Attachment" type="file" class="validate"  name="attachment">
              ...
              <div class="row">
                <div class="input-field col s6">
                    ...
                    <button class="btn waves-effect waves-light cyan btn-sm" type="submit" name="action">Submit</button>
                        <a href="{{route('ApplyLeave')}}" class="btn waves-effect waves-light danger btn-sm"  >Cancel</a>

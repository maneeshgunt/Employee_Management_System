...
<head>
    ...
    <div class="col s12">
      <div class="card">
          ...
          <form action="{{route('aAddTimesheet')}}" method="post" class="col s12">
             @csrf
                ...
                <div class=" col s6">
                  <label>Departments
                    <select name="department">
                        ...
                        <option value="Addministration">Addministration</option>
              ...
              <div class="row">
                ...
                <div class="input-field col s6">
                  <label >1st Hr</label>
                <input id="icon_telephone3" type="Text" name="hr1">
                 @if($errors->has('hr1'))
                  <span class="text-danger">{{ $errors->first('hr1') }}</span>
                @endif
              ...
              <input id="icon_telephone3" type="Text" name="hr2">
               @if($errors->has('hr2'))
                  <span class="text-danger">{{ $errors->first('hr2') }}</span>
                @endif
        ...
        <div class="row">
          ...
          <div class="input-field col s6">
            <label >3rd Hr</label>
          <input id="icon_telephone3" type="Text" name="hr3" >
           @if($errors->has('hr3'))
                  <span class="text-danger">{{ $errors->first('hr3') }}</span>
                @endif
        ...
        <input id="icon_telephone3" type="Text" name="hr4">
         @if($errors->has('hr4'))
                  <span class="text-danger">{{ $errors->first('hr4') }}</span>
                @endif
  ...
  <div class="row">
    ...
    <div class="input-field col s6">
      <label >5th Hr</label>
    <input id="icon_telephone3" type="Text" name="hr5" >
     @if($errors->has('hr5'))
                  <span class="text-danger">{{ $errors->first('hr5') }}</span>
                @endif
  ...
  <input id="icon_telephone3" type="Text" name="hr6" >
   @if($errors->has('hr6'))
                  <span class="text-danger">{{ $errors->first('hr6') }}</span>
                @endif
...
<div class="row">
  ...
  <div class="input-field col s6">
    <label >7th Hr</label>
  <input id="icon_telephone3" type="Text" name="hr7">
   @if($errors->has('hr7'))
                  <span class="text-danger">{{ $errors->first('hr7') }}</span>
                @endif
...
<input id="icon_telephone3" type="Text" name="hr8">
 @if($errors->has('hr8'))
                  <span class="text-danger">{{ $errors->first('hr8') }}</span>
                @endif
...
<div class="row">
  ...
  <div class="input-field col s6">
    <label >9th Hr</label>
  <input id="icon_telephone3" type="Text" name="hr9">
   @if($errors->has('hr9'))
                  <span class="text-danger">{{ $errors->first('hr9') }}</span>
                @endif
...
<input id="icon_telephone3" type="Text" name="hr10">

 @if($errors->has('hr10'))
                  <span class="text-danger">{{ $errors->first('hr10') }}</span>
                @endif
</div>
...
<div class="row">
  ...
  <div class="input-field col s6">
    <label >11th Hr</label>
  <input id="icon_telephone3" type="Text" name="hr11">
...
<input id="icon_telephone3" type="Text" name="hr12">
...
<div class="row">
  ...
  <div class="input-field col s6">
    ...
    <input id="icon_telephone" type="time" class="validate" name="intime">
    <label for="icon_telephone"> In time</label>
     @if($errors->has('intime'))
                  <span class="text-danger">{{ $errors->first('intime') }}</span>
                @endif
  </div>

  <div class="input-field col s6">
               
    <input id="icon_telephone" type="time" class="validate" name="outtime">
    <label for="icon_telephone">Out Time</label>
     @if($errors->has('outtime'))
              ...
              <button class="btn waves-effect waves-light cyan  btn-sm " type="submit" name="action" >Submit</button>
                <!--<button class="btn waves-effect waves-light danger btn-sm" type="submit">Cancel</button>-->
                
              <a href="{{ route('EmpDailyTimeSheet')}}" class="btn waves-effect waves-light   btn-sm ">Cancel</a>

          ...
          <div class="container">
            <div class="row">
              <div class="col s10 m6 l6">
                <h5 class="breadcrumbs-title mt-0 mb-0"><span>PayRoll</span></h5>
...
<div class="col s4">
          <select placeholder="Select Month" >
            <option name="" value="none" style="display:none;">Select Month</option>
                ...
                <table id="page-length-option" class="display">
                    <thead>
                      <tr>
                        ...
                        <th style="font-weight: 700;">Download Salaryslip</th>
                      </tr>
                    </thead>
                    <tbody>
                    @foreach($mangepayslips as $data)
                      <tr>
                        ...
                        <td>
                           <a href="" class="btn waves-effect waves-light cyan btn-sm" type="button" name="action"><i class='fa fa-download'></i></a>

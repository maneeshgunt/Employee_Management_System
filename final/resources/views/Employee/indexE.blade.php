      ...
      <div class="col s12 m6 l4">
         <div class="card padding-4 animate fadeLeft">
            <div class="row">
               <div class="col s5 m5">
                   @php 
                   $auth = Auth::guard('employee')->user()->full_name;
                   
                     $total = DB::table('manage_leaves')->select('name')->where('name', '=', $auth)->get();
           ...
           <div class="row">
              <div class="col s5 m5">
                  @php 
                   ...
                   @endphp
                 <h5 class="mb-0">{{ count($total) }}</h5>
                 <p class="no-margin">Pending Leave</p>
   ...
   <div class="col s12 m6 l4">
    <div class="card padding-4 animate fadeLeft">
       <div class="row">
          <div class="col s5 m5">
             <h5 class="mb-0">10</h5>
             <p class="no-margin">Performance</p>
    ...
    <div class="col s12 m6 l4">
      <div class="card-panel border-radius-6 white-text gradient-45deg-deep-purple-blue card-animation-2">
        <h6 class="mt-5"><b><a href="#" class="white-text">Happy Birthday jeni</a></b></h6>
    ...
    <div class="col s12 m6 l4">
      <div class="card-panel border-radius-6 white-text gradient-45deg-purple-deep-orange card-animation-2">
        <h6 class="mt-5"><b><a href="#" class="white-text">Team meating shedule on saturday</a></b></h6>
        <span>Sophia Fiori is one of the most famous jewelry designer in the USA. Sophia Fiori 
        </span>
        <div class="display-flex justify-content-between flex-wrap mt-4">
          <div class="display-flex align-items-center mt-1">
    ...
    <div class="col s12 m6 l4">
      <div class="card-panel border-radius-6 white-text gradient-45deg-indigo-light-blue card-animation-2">
        <h6 class="mt-5"><b><a href="#" class="white-text">API traning shedule on saturdays</a></b></h6>
...
<!-- Mirrored from pixinvent.com/materialize-material-design-admin-template/html/ltr/vertical-modern-menu-template/dashboard-modern.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 16 Nov 2021 11:09:50 GMT -->
</html>
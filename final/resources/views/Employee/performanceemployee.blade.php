          ...
          <div class="container">
            <div class="row">
              <div class="col s10 m6 l6">
                <h5 class="breadcrumbs-title mt-0 mb-0"><span>Performance</span></h5>
              ...
              <table id="page-length-option" class="display">
                <thead>
                  <tr>
                   ...
                   <th style="font-weight: 700;">Month</th>
                    ...
                    <th style="font-weight: 700;">View </th>
                    
                       <th style="font-weight: 700;">Raise a query </th>
                ...
                <tbody>
                  <tr>
                    ...
                    <td>  <a href="{{ route('empperformancedetail')}}"><button class="btn waves-effect waves-light cyan btn-sm" type="button" name="action">View</button></a></td>
                      ...
                      <a class="waves-effect waves-light btn modal-trigger cyan" href="#proposal" >Raise a query</a>

        ...
        <div class="container">
          <div class="row">
            <div class="col s10 m6 l6">
              <h5 class="breadcrumbs-title mt-0 mb-0"><span>Task Information</span></h5>
                    ...
                    <div class="row">
                      <div class="col s12">
                        <table id="page-length-option" class="display">
                          <thead>
                            <tr>
                              ...
                              <th><b style="font-weight: 700;">Assign Date</b></th>
                            ...
                            <th><b style="font-weight: 700;">Developer Hours</b></th>
                              <th><b style="font-weight: 700;">Developer Status</th>
                             <th><b style="font-weight: 700;">Tester Status</th>
                              
                              <th><b style="font-weight: 700;">Action</th>
                        ...
                        @foreach($tasks as $data)
                            ...
                            <td>
                              <a href="{{ route('EmployeeTaskStatus',$data->id)}}" class="btn waves-effect waves-light cyan btn-sm" type="submit" name="action"><i class='fa fa-edit'></i></button></td>
                          </tr>
                          @endforeach
                          </tbody>

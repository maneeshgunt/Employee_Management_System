        ...
        <div class="container">
          <div class="row">
            <div class="col s10 m6 l6">
              <h5 class="breadcrumbs-title mt-0 mb-0"><span> Leaves</span></h5>
              ...
              <div class="col s12">
                <div class="card">
                  ...
                  <div class="card-content">
                    ...
                    <a href="{{route('AddLeave')}}"><button class="btn waves-effect waves-light cyan btn-sm" type="submit" name="action">Apply Leave</button></a>
               ...
               <div class="col s12 m6 l4">
                  <div class="card padding-4 animate fadeLeft">
                     <div class="row">
                        <div class="col s5 m5">
                           <h5 class="mb-0">18</h5>
                           <p class="no-margin">Total Leave</p>
               ...
               <div class="col s12 m6 l4">
                 <div class="card padding-4 animate fadeLeft">
                    <div class="row">
                       <div class="col s5 m5">
                          <h5 class="mb-0">4</h5>
                          <p class="no-margin">Paid Leaves </p>
             ...
             <div class="col s12 m6 l4">
               <div class="card padding-4 animate fadeLeft">
                  <div class="row">
                     <div class="col s5 m5">
                        <h5 class="mb-0">4</h5>
                        <p class="no-margin">Unpaid Leaves</p>
                        ...
                        <table id="page-length-option" class="display">
                          <thead>
                            <tr>
                              ...
                              <th><b style="font-weight: 700;">From Date</b></th>
                              <th><b style="font-weight: 700;">To Date</b></th>
                              <th><b style="font-weight: 700;">Leave Reason</b></th>
                              <th><b style="font-weight: 700;">Leave Days</b></th>
                              <th><b style="font-weight: 700;">Leave Status</b></th>
                              <th><b style="font-weight: 700;">Attachment</b></th>
                              <th><b style="font-weight: 700;">Comments</b></th>
                            </tr>
                          </thead>
                          <tbody>
                            @foreach($manageleaves as $data)
                            <tr>
                              <td>{{$data->id}}</td>
                              <td>{{$data->date}}</td>
                              <td>{{$data->end_date}}</td>

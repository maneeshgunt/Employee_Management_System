...
<head>
    ...
    <div class="col s12">
      <div class="card">
        ...
        <div class="card-content">
          ...
          <form action="{{route('aAddTimesheet')}}" method="post" class="col s12">
              ...
              <div class="row">
                ...
                <div class="input-field col s6">
                  <label >1st Hr</label>
                <input id="icon_telephone3" type="Text" name="1hr">
              ...
              <input id="icon_telephone3" type="Text" name="2hr">
        ...
        <div class="row">
          ...
          <div class="input-field col s6">
            <label >3rd Hr</label>
          <input id="icon_telephone3" type="Text" name="3hr" >
        ...
        <input id="icon_telephone3" type="Text" name="4hr">
  ...
  <div class="row">
    ...
    <div class="input-field col s6">
      <label >5th Hr</label>
    <input id="icon_telephone3" type="Text" name="5hr" >
  ...
  <input id="icon_telephone3" type="Text" name="6hr" >
...
<div class="row">
  ...
  <div class="input-field col s6">
    <label >7th Hr</label>
  <input id="icon_telephone3" type="Text" name="7hr">
...
<input id="icon_telephone3" type="Text" name="8hr">
...
<div class="row">
  ...
  <div class="input-field col s6">
    <label >9th Hr</label>
  <input id="icon_telephone3" type="Text" name="9hr">
...
<input id="icon_telephone3" type="Text" name="10hr">
...
<div class="row">
  ...
  <div class="input-field col s6">
    <label >11th Hr</label>
  <input id="icon_telephone3" type="Text" name="11hr">
...
<input id="icon_telephone3" type="Text" name="12hr">

    ...
    <div class="col s12">
      <div class="card">
        ...
        <div class="card-content">
          ...
          <img style="position:relative;" width="150px"height="50px"  src="{{ asset('Admin/app-assets/images/logo/Scriptikalogo.png')}}" /></td>
          ...
          <div class="salary1" >
            ...
            <!-- <tr>
                ...
                <td colspan='4' class="companyName" style="color:white ;">Scriptika Solutions</td> 
              </tr>  -->
              <tr>
                <th>
                 Employee Name
                ...
                <td>
                  {{$mangepayslips[0]->totalworkingdays}} 
      </td>
              </tr>
              <tr>
                <th>
      ...
      <td></td>
                ...
                <td>
                  {{$mangepayslips[0]->bankaccountnumber}} 
      </td>
              </tr>
    ...
    {{$mangepayslips[0]->uan}} 
      ...
      <td></td>
              ...
              <tr>
                ...
                <td class="myAlign">
                 {{$mangepayslips[0]->houserentallowance}} 
      </td>
                <th colspan="2" >
                Helth Insurance/ESI
      </th >
                ...
                <td class="myAlign">
               {{$mangepayslips[0]->healthinsurance}} 
      </td>
              </tr >
              <tr>
                <th colspan="2">
                ...
                <td class="myAlign">
                 {{$mangepayslips[0]->conveyanceallowance}} 
      </td>
                <th colspan="2" >
                 Professional Tax
      </th >
                ...
                <td class="myAlign">
                  {{$mangepayslips[0]->professionaltax}} 
              </tr >
              <tr>
                <th colspan="2">
                  Medical Allowance
                ...
                <td></td>
                <td class="myAlign">
                 {{$mangepayslips[0]->medicalallowance}} 
      </td>
                <th colspan="2" >
              ...
              <tr>
                ...
                <td class="myAlign">
                 {{$mangepayslips[0]->specialallowance}} 
      </td>
                <th colspan="2" >
              ...
              <tr>
               ...
               Total Deduction
                ...
                <td class="myAlign">
                {{$mangepayslips[0]->totaldeduction}} 
      </td> 
              </tr >
              <tr>
                <th colspan="2">
              ...
              <tr>
                ...
                <td></td>
                <td class="myAlign border-center">
                <b> Net Pay</b>
      </td>
                <th colspan="2" >
              ...
              <tbody class="border-center">
                ...
                <tr>
                  ...
                  <td colspan="4">Employer Signature </td>
                  <td ></td>
                  <td > </td>

        ...
        <div class="card-content">
          ...
          <div class="row">
            <form class="col s12">
              ...
              <div class="input-field col s6">
                <br>
          <button class="btn waves-effect waves-light cyan  btn-sm" type="button" name="action">UPLOAD</a>
              </div>
          </div>
          ...
          <h5>Create Offer Letter</h5>
              ...
              <div class="">
                <div class="">
                    ...
                    <a href="adminofferletter.html"><button class="btn waves-effect waves-light cyan  btn-sm" type="button" name="action">View Offer letter</button></a>
                </div>

          ...
          <div class="container">
            <div class="row">
              <div class="col s10 m6 l6">
                <h5 class="breadcrumbs-title mt-0 mb-0"><span>Offer</span></h5>
  ...
  <div class="row">
    <div class="col s12">
      <div class="card">
       ...
       <a href="{{ route('CreateOffer')}}"><button class="btn waves-effect waves-light cyan btn-sm" type="submit" name="action">Create Offer</button></a>
           <br><br>
            ...
            <div class="col s12">
                <table id="page-length-option" class="display">
                    ...
                    <tbody>
                        ...
                        <td>11012</td>
                        <td>
                            <a href="{{route('EditOffer')}}"><button class="btn waves-effect waves-light cyan btn-sm" type="button" na><i class='fa fa-edit'></i></button></a>
